...
if ( class_exists("Kirki")){
    ...
    Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'settings'    => 'grocery_supermarket_elementor_show_footer_widget_heading',
		'section'     => 'grocery_supermarket_elementor_footer_section',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Enable / Disable', 'grocery-supermarket-elementor' ) . '</h3>',
		'priority'    => 10,
	] );

	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'settings'    => 'grocery_supermarket_elementor_show_footer_widget',
		'label'       => esc_html__( 'Footer Widget', 'grocery-supermarket-elementor' ),
		'section'     => 'grocery_supermarket_elementor_footer_section',
		'default'     => '1',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'settings'    => 'grocery_supermarket_elementor_show_footer_copyright',
		'label'       => esc_html__( 'Footer Copyright', 'grocery-supermarket-elementor' ),
		'section'     => 'grocery_supermarket_elementor_footer_section',
		'default'     => '1',
		'priority'    => 10,
	] );
