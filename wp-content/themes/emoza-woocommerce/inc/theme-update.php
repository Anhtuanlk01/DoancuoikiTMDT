...
function emoza_hf_update_notice_1_1_9() {
    ...
    <div class="notice notice-success thd-theme-dashboard-notice-success is-dismissible">
        ...
        <p>
            ...
            printf( esc_html__( 'Want to see the new header and footer builder before upgrading? Check out our %s.', 'emoza-woocommerce' ), '<a target="_blank" href="https://emoza.org/docs/">documentation</a>' ); ?>
        </p>
 ...
 * @since 1.1.0
 */
function emoza_single_product_elements_merchant_modules() {
	...
	$flag = get_theme_mod( 'emoza_single_product_elements_merchant_modules_flag', false );
    ...
    $modules_to_migrate = Emoza_Merchant_Single_Product_Elements::$modules_data;
	...
	// Set flag
	set_theme_mod( 'emoza_single_product_elements_merchant_modules_flag', true );
}
add_action( 'init', 'emoza_single_product_elements_merchant_modules' );
