...
foreach( $rows as $row ) {
    ...
    // Background Color
    $css .= Emoza_Custom_CSS::get_background_color_css( "emoza_header_row__{$row}_background_color", '#FFF', ".bhfb-$row" );
    ...
    $css .= Emoza_Custom_CSS::get_border_bottom_color_rgba_css( "emoza_header_row__{$row}_border_bottom_color", '#EAEAEA', ".bhfb-$row", 0.1 );
    ...
    if( emoza_sticky_header_enabled() ) {
        ...
        $css .= Emoza_Custom_CSS::get_background_color_css( "emoza_header_row__{$row}_sticky_background_color", '', ".sticky-header-active .has-sticky-header .bhfb-$row" ); 

        // Sticky Header - Border Bottom Color
        $css .= Emoza_Custom_CSS::get_border_bottom_color_rgba_css( "emoza_header_row__{$row}_sticky_border_bottom_color", '#EAEAEA', ".sticky-header-active .has-sticky-header .bhfb-$row" );
