...
$css .= "
    ...
    @media (min-width: {$min_width}px) {
        ...
        .bhfb-header .emoza-dropdown > .emoza-dropdown-ul,
        .bhfb-header .emoza-dropdown > div > .emoza-dropdown-ul {
            display: -webkit-box;
            display: -ms-flexbox;
            display: flex;
            -ms-flex-wrap: wrap;
...
// Background Color
$css .= Emoza_Custom_CSS::get_background_color_css( 'emoza_section_hb_wrapper__header_builder_background_color', '', '.bhfb-header.bhfb-desktop, .bhfb-header.bhfb-mobile' );
