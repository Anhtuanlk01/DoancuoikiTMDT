...
$wp_customize->add_control( new Emoza_Text_Control( $wp_customize, 'emoza_section_hb_wrapper__header_builder_available_components',
		array(
			'description' 	=> '<span class="customize-control-title" style="font-style: normal;">'. esc_html__( 'Available Components', 'emoza-woocommerce' ) .'</span><div class="bhfb-available-components emoza-header-builder-available-components emoza-bhfb-area"></div>',
			'section' 		=> 'emoza_section_hb_wrapper',
            'priority' 		=> 40
		)
	)
...
$wp_customize->add_control( new Emoza_Text_Control( $wp_customize, 'emoza_section_hb_wrapper__header_builder_available_mobile_components',
		array(
			'description' 	=> '<span class="customize-control-title" style="font-style: normal;">'. esc_html__( 'Available Components', 'emoza-woocommerce' ) .'</span><div class="bhfb-available-components emoza-header-builder-available-mobile-components emoza-bhfb-area"></div>',
			'section' 		=> 'emoza_section_hb_wrapper',
            'priority' 		=> 40
		)
	)
...
// Upsell
if( ! defined( 'EMOZA_AWL_ACTIVE' ) && ! defined( 'EMOZA_PRO_VERSION' ) ) {
	$wp_customize->add_setting( 
