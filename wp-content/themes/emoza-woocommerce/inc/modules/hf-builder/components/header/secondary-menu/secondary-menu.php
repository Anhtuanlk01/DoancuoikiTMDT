...
<div class="bhfb-builder-item bhfb-component-secondary_menu" data-component-id="secondary_menu">
    ...
    <?php else: 
        ...
        ?>
    <nav class="top-bar-secondary-navigation secondary-navigation emoza-dropdown bhfb-navigation<?php echo 'yes' === $has_hover_delay ? ' with-hover-delay' : ''; ?>" aria-label="<?php echo esc_attr__( 'Secondary Navigation Menu', 'emoza-woocommerce' ); ?>">
        <?php
        wp_nav_menu( array(
