...
$wp_customize->add_control( new Emoza_Text_Control( $wp_customize, 'emoza_section_fb_wrapper__footer_builder_available_footer_components',
		array(
			'description' 	=> '<span class="customize-control-title" style="font-style: normal;">'. esc_html__( 'Available Components', 'emoza-woocommerce' ) .'</span><div class="bhfb-available-components emoza-footer-builder-available-footer-components emoza-bhfb-area"></div>',
			'section' 		=> 'emoza_section_fb_wrapper',
            'priority' 		=> 40
		)
	)
