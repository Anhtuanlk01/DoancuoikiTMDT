...
// Icon Color
$css .= Emoza_Custom_CSS::get_fill_css( 'bhfb_footer_social_color', '', '.bhfb-footer .bhfb-component-social .social-profile > a svg' );

// Icon Color Hover
$css .= Emoza_Custom_CSS::get_fill_css( 'bhfb_footer_social_color_hover', '', '.bhfb-footer .bhfb-component-social .social-profile > a:hover svg' );
