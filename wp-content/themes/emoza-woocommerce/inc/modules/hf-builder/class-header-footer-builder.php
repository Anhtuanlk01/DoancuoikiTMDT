...
class Emoza_Header_Footer_Builder {
    ...
    public function admin_enqueue_scripts() {
        ...
        wp_enqueue_style( 'emoza-bhfb', get_template_directory_uri() . '/assets/css/admin/emoza-bhfb.min.css', array(), EMOZA_VERSION );
        wp_enqueue_script( 'emoza-bhfb', get_template_directory_uri() . '/assets/js/admin/emoza-bhfb.min.js', array(), EMOZA_VERSION, true );
        wp_localize_script( 'emoza-bhfb', 'emoza_hfb', array(
            'rows' => array(
                'defaults' => array(
            ...
            'upsell_components' => array(
                'enable' => ! defined( 'EMOZA_AWL_ACTIVE' ) && ! defined( 'EMOZA_PRO_VERSION' ) ? true : false,
    ...
    public function customize_preview_scripts() {
        wp_enqueue_style( 'emoza-bhfb-customize-preview', get_template_directory_uri() . '/assets/css/admin/emoza-bhfb-customize-preview.min.css', array(), EMOZA_VERSION );
        wp_enqueue_script( 'emoza-bhfb-customize-preview', get_template_directory_uri() . '/assets/js/admin/emoza-bhfb-customize-preview.min.js', array(), EMOZA_VERSION, true );
    }
    ...
    public function enqueue_scripts() {
        wp_enqueue_style( 'emoza-bhfb', get_template_directory_uri() . '/assets/css/emoza-bhfb.min.css', array(), EMOZA_VERSION );
    }
    ...
    public function header_builder_admin_grid( $area ) { 
        ...
        ?>
        <div class="emoza-bhfb emoza-bhfb-<?php echo esc_attr( $area ); ?>">
            <div class="emoza-bhfb-devices">
                <div class="emoza-bhfb-device">
                    <a href="#" class="emoza-bhfb-device-link active" data-device="desktop">
                        <span class="dashicons dashicons-desktop"></span>
                        <?php echo esc_html__( 'Desktop', 'emoza-woocommerce' ); ?>
                    </a>
                </div>
                <div class="emoza-bhfb-device">
                    <a href="#" class="emoza-bhfb-device-link" data-device="tablet">
                        <span class="dashicons dashicons-smartphone"></span>
                        <?php echo esc_html__( 'Tablet/Mobile', 'emoza-woocommerce' ); ?>
                    </a>
                </div>
            </div>
            <div class="emoza-bhfb-top">
                <div id="emoza-bhfb-elements" class="emoza-bhfb-elements">
                    <div class="emoza-bhfb-elements-wrapper">
                        <div class="emoza-bhfb-elements-desktop"></div>
                        <div class="emoza-bhfb-elements-mobile"></div>
                    </div>
                </div>
                <div class="emoza-bhfb-desktop">
                    <div class="emoza-bhfb-rows-wrapper">
                        <div class="emoza-bhfb-row emoza-bhfb-row-top emoza-bhfb-above-row">
                            <div class="emoza-bhfb-row-controls">
                            ...
                            <div class="emoza-bhfb-area emoza-bhfb-area-left" data-bhfb-row="above_<?php echo esc_attr( $area ); ?>_row" data-bhfb-column="left"></div>
                            <div class="emoza-bhfb-area emoza-bhfb-area-center" data-bhfb-row="above_<?php echo esc_attr( $area ); ?>_row" data-bhfb-column="center"></div>
                            <div class="emoza-bhfb-area emoza-bhfb-area-right" data-bhfb-row="above_<?php echo esc_attr( $area ); ?>_row" data-bhfb-column="right"></div>
                        </div>
                        <div class="emoza-bhfb-row emoza-bhfb-row-main emoza-bhfb-main-row">
                            <div class="emoza-bhfb-row-controls">
                            ...
                            <div class="emoza-bhfb-area emoza-bhfb-area-left" data-bhfb-row="main_<?php echo esc_attr( $area ); ?>_row" data-bhfb-column="left"></div>
                            <div class="emoza-bhfb-area emoza-bhfb-area-center" data-bhfb-row="main_<?php echo esc_attr( $area ); ?>_row" data-bhfb-column="center"></div>
                            <div class="emoza-bhfb-area emoza-bhfb-area-right" data-bhfb-row="main_<?php echo esc_attr( $area ); ?>_row" data-bhfb-column="right"></div>
                        </div>
                        <div class="emoza-bhfb-row emoza-bhfb-row-bottom emoza-bhfb-below-row">
                            <div class="emoza-bhfb-row-controls">
                            ...
                            <div class="emoza-bhfb-area emoza-bhfb-area-left" data-bhfb-row="below_<?php echo esc_attr( $area ); ?>_row" data-bhfb-column="left"></div>
                            <div class="emoza-bhfb-area emoza-bhfb-area-center" data-bhfb-row="below_<?php echo esc_attr( $area ); ?>_row" data-bhfb-column="center"></div>
                            <div class="emoza-bhfb-area emoza-bhfb-area-right" data-bhfb-row="below_<?php echo esc_attr( $area ); ?>_row" data-bhfb-column="right"></div>
                        </div>
                    </div>
                </div>
                <div class="emoza-bhfb-mobile">
                    <div class="bhfb-offcanvas">
                        ...
                        <div class="bhfb-offcanvas-components-wrapper">
                            <div class="emoza-bhfb-area emoza-bhfb-area-offcanvas" data-bhfb-row="mobile_offcanvas" data-bhfb-column="left"></div>
                        </div>
                    </div>
                    <div class="emoza-bhfb-rows-wrapper">
                        <div class="emoza-bhfb-row emoza-bhfb-row-top emoza-bhfb-above-row">
            ...
            <div class="emoza-bhfb-bottom">
                <div class="emoza-bhfb-bottom-upsell"></div>
                <a href="#" class="emoza-bhfb-bottom-settings" onClick="wp.customize.section('emoza_section_<?php echo esc_js( $area_prefix ); ?>_wrapper').focus();">
                    <span class="dashicons dashicons-admin-generic"></span>
                </a>
                <a href="#" class="emoza-bhfb-bottom-display">
                    <div class="emoza-bhfb-bottom-display-show">
                        <span class="dashicons dashicons-arrow-up-alt2"></span>
                        <?php echo esc_html__( 'Show', 'emoza-woocommerce' ); ?>
                    </div>
                    <div class="emoza-bhfb-bottom-display-hide">
    ...
    public function header_front_output() {
        ...
        foreach( $devices as $device ) { ?>
            ...
            <header class="bhfb bhfb-header bhfb-<?php echo esc_attr( $device ); ?><?php echo ( $device === 'desktop' && $sticky_header ? ' has-sticky-header sticky-' . esc_attr( $sticky_header_type ) . ' sticky-row-' . esc_attr( $sticky_row ) : '' ); ?>"<?php echo $device === 'desktop' && ! empty($sticky_header_styles) ? 'style="' . esc_attr( implode( ' ', $sticky_header_styles ) ) . '"' : ''; ?> <?php emoza_schema( 'header' ); ?>> <?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                ...
                <?php 
                /**
                 * Hook 'emoza_bhfb_header_inner_before'
                 *
                 * @since 1.0.0
                 */
                do_action( 'emoza_bhfb_header_inner_before' ); ?>
                ...
                <div class="bhfb-rows">
                    ...
                    foreach( $this->header_rows as $row ) { 
                        ...
                        <div <?php echo implode( ' ', $attributes ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
                            ...
                            <?php 
                            /**
                             * Hook 'emoza_bhfb_header_{$row['id']}_before'
                             *
                             * @since 1.0.0
                             */
                            do_action( "emoza_bhfb_header_{$row['id']}_before" ); ?>

                            <?php $this->rows_callback( 'header', $row['id'], $device ); ?>

                            <?php 
                            /**
                             * Hook 'emoza_bhfb_header_{$row['id']}_after'
                             *
                             * @since 1.0.0
                             */
                            do_action( "emoza_bhfb_header_{$row['id']}_after" ); ?>
                        </div>
                ...
                <?php 
                /**
                 * Hook 'emoza_bhfb_header_inner_after'
                 *
                 * @since 1.0.0
                 */
                do_action( 'emoza_bhfb_header_inner_after' ); ?>

                <?php 
                /**
                 * Hook 'emoza_before_bhfb_header_output_close_$device'
                 *
                 * @since 1.0.0
                 */
                do_action( "emoza_before_bhfb_header_output_close_$device" ); ?>
            </header>
    ...
    public function mobile_offcanvas_output() {
         ...
         * @since 1.0.0
         */
        $mobile_offcanvas_classes = apply_filters( 'emoza_mobile_offcanvas_classes', array( 'bhfb', 'bhfb-mobile_offcanvas', 'emoza-offcanvas-menu' ) );
    ...
    public function footer_front_output() {
        ...
        foreach( $devices as $device ) { ?>
            ...
            <footer class="bhfb bhfb-footer bhfb-<?php echo esc_attr( $device ); ?>" <?php emoza_schema( 'footer' ); ?>>

                <?php 
                /**
                 * Hook 'emoza_bhfb_footer_inner_before'
                 *
                 * @since 1.0.0
                 */
                do_action( 'emoza_bhfb_footer_inner_before' ); ?>
                ...
                <div class="bhfb-rows">
                    ...
                    foreach( $this->footer_rows as $row ) { 
                        ...
                        <div <?php echo implode( ' ', $attributes ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
                            ...
                            <?php 
                            /**
                             * Hook 'emoza_bhfb_footer_{$row['id']}_before'
                             *
                             * @since 1.0.0
                             */
                            do_action( "emoza_bhfb_footer_{$row['id']}_before" ); ?>

                            <?php $this->rows_callback( 'footer', $row['id'], $device ); ?>

                            <?php 
                            /**
                             * Hook 'emoza_bhfb_footer_{$row['id']}_after'
                             *
                             * @since 1.0.0
                             */
                            do_action( "emoza_bhfb_footer_{$row['id']}_after" ); ?>
                        </div>
                ...
                <?php 
                /**
                 * Hook 'emoza_bhfb_footer_inner_after'
                 *
                 * @since 1.0.0
                 */
                do_action( 'emoza_bhfb_footer_inner_after' ); ?>

                <?php 
                /**
                 * Hook 'emoza_before_bhfb_footer_output_close_$device'
                 *
                 * @since 1.0.0
                 */
                do_action( "emoza_before_bhfb_footer_output_close_$device" ); ?>
            </footer>
