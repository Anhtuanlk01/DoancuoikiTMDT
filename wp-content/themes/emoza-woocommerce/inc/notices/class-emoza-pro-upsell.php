...
class Emoza_Pro_Upsell_Notice {
	...
	public function notice_markup() {
		...
		<div class="emoza-notice emoza-notice-with-thumbnail notice" style="position:relative;">
			<h3><?php echo esc_html__( 'Earn More with Your Emoza Store! 💰', 'emoza-woocommerce' ); ?></h3>

			<p>
				<?php
					echo esc_html__(
						'Emoza Pro offers 40+ conversion-boosting features created specifically for the Emoza theme. Wishlists, size charts, advanced reviews, variation swatches, gallery styles, and many more! Join the thousands of happy entrepreneurs who have already taken their Emoza store to the next level.', 'emoza-woocommerce'
					);
				?>
			</p>
