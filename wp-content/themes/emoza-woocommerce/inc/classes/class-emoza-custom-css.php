...
if ( !class_exists( 'Emoza_Custom_CSS' ) ) :
	...
	class Emoza_Custom_CSS {
		...
		public function __construct() { 
			...
			add_action( 'emoza_admin_module_activated', array( $this, 'set_update_custom_css_flag' ) );
			add_action( 'emoza_admin_module_deactivated', array( $this, 'set_update_custom_css_flag' ) );
			add_action( 'emoza_admin_all_modules_activated', array( $this, 'set_update_custom_css_flag' ) );
			add_action( 'emoza_admin_all_modules_deactivated', array( $this, 'set_update_custom_css_flag' ) );
		...
		public function set_update_custom_css_flag() {
			set_transient( 'emoza_update_custom_css_flag', true, 0 );
		}
		...
		public static function get_typography_css( $context = 'frontend' ) {
			...
			if( $fonts_library === 'google' ) {
				...
				$header_menu_font                = get_theme_mod( 'emoza_header_menu_font', $body_font );
				...
				if ( 'System default' !== $shop_product_title_font['font'] ) {
					$selectors = array( 
						'ul.products li.product .emoza-wc-loop-product__title', 
						...
						'.woocommerce-loop-product__title .emoza-wc-loop-product__title', 
					);
					$selector = self::get_mounted_selector( $selectors, $empty_selector );
				...
				if ( 'System default' !== $header_menu_font['font'] ) {
					...
					if( class_exists( 'Emoza_Modules' ) && Emoza_Modules::is_module_active( 'hf-builder' ) ) {
						$selectors = array( 
						...
						$selectors = array( 
							...
							'.emoza-offcanvas-menu .main-navigation', 
			...
			if( $fonts_library === 'adobe' ) {
				$body_font                       = get_theme_mod( 'emoza_body_adobe_font', 'system-default|n4' );
				$headings_font                   = get_theme_mod( 'emoza_headings_adobe_font', 'system-default|n4' );
				$header_menu_font                = get_theme_mod( 'emoza_header_menu_adobe_font', $body_font );
			...
			if( $fonts_library === 'custom' ) {
				...
				// Embed custom fonts
				$css .= emoza_get_custom_fonts() . "\n";   

				$body_font                       = get_theme_mod( 'emoza_body_custom_font', 'System default' );
				$headings_font                   = get_theme_mod( 'emoza_headings_custom_font', '' );
				$header_menu_font                = get_theme_mod( 'emoza_header_menu_custom_font', $body_font );
		...
		public function output_css( $custom_css = false ) {
			...
			if ( class_exists( 'Emoza_Modules' ) && Emoza_Modules::is_module_active( 'hf-builder' ) ) {
				...
				/**
				 * Hook 'emoza_bhfb_custom_css'
				 *
				 * @since 1.0.0
				 */
				$css .= apply_filters( 'emoza_bhfb_custom_css', Emoza_Header_Footer_Builder::custom_css() );
				...
				$css .= $this->get_background_color_css( 'topbar_submenu_background_color', '', '.top-bar .top-bar-login-register nav, .top-bar .emoza-dropdown .sub-menu .emoza-dropdown-li' );
				...
				$css .= $this->get_fill_css( 'topbar_color_hover', '', '.top-bar .emoza-dropdown .emoza-dropdown-li:hover > .dropdown-symbol .ws-svg-icon svg' );
				...
				$css .= $this->get_color_css( 'main_header_color', '', '.site-header .site-title a,.site-header .site-description,.site-header .emoza-dropdown .menu > .emoza-dropdown-li > .emoza-dropdown-link, .site-header .header-contact a, .site-header .header-login-register>a, .site-header .header-login-register nav>a' );
				$css .= $this->get_color_css( 'main_header_color_hover', '', '.site-header .site-title a:hover,.site-header .emoza-dropdown .menu > .emoza-dropdown-li > .emoza-dropdown-link:hover, .site-header .header-contact a:hover, .site-header .header-login-register>a:hover, .site-header .header-login-register nav>a:hover, .site-header .emoza-dropdown .menu > .emoza-dropdown-li:hover > .emoza-dropdown-link, .site-header .header-contact a:hover' );
				...
				$css .= $this->get_background_color_css( 'main_header_color', '', '.site-header .emoza-image.is-svg' );
				$css .= $this->get_fill_css( 'main_header_color_hover', '', '.site-header .emoza-dropdown .menu > .emoza-dropdown-li:hover > .dropdown-symbol svg, .site-header a:hover svg:not(.stroke-based), .site-header a:hover svg:not(.stroke-based), .site-header a:hover .dropdown-symbol .ws-svg-icon svg' );
				$css .= $this->get_background_color_css( 'main_header_color_hover', '', '.site-header .emoza-image.is-svg:hover' );
				...
				$css .= $this->get_color_css( 'main_header_bottom_color', '#212121', '.bottom-header-row, .bottom-header-row .header-contact a,.bottom-header-row .emoza-dropdown .menu > .emoza-dropdown-li > .emoza-dropdown-link' );
				$css .= $this->get_color_css( 'main_header_bottom_color_hover', '#757575', '.bottom-header-row .header-contact a:hover,.bottom-header-row .emoza-dropdown .menu > .emoza-dropdown-li:hover > .emoza-dropdown-link' );
				...
				$css .= $this->get_fill_css( 'main_header_bottom_color_hover', '#757575', '.bottom-header-row .emoza-dropdown .menu > .emoza-dropdown-li:hover > .dropdown-symbol svg' );
				...
				$css .= $this->get_background_color_css( 'main_header_submenu_background', '', '.site-header .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-ul .emoza-dropdown-li, .site-header .header-login-register nav, .bottom-header-row .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-ul .emoza-dropdown-li, .emoza-desktop-offcanvas-menu .emoza-dropdown .emoza-mega-menu>.sub-menu>.emoza-dropdown-li>.sub-menu .menu-item-has-children:hover>.sub-menu' );
				$css .= $this->get_color_css( 'main_header_submenu_color', '#212121', '.site-header .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-ul .emoza-dropdown-link, .site-header .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-ul > .emoza-dropdown-li:hover > .dropdown-symbol svg, .site-header .header-login-register nav>a, .bottom-header-row .header-login-register nav>a' );
				$css .= $this->get_color_css( 'main_header_submenu_color_hover', '#757575', '.site-header .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-ul .emoza-dropdown-li:hover > .emoza-dropdown-link, .site-header .header-login-register nav>a:hover, .bottom-header-row .header-login-register nav>a:hover' );
				$css .= $this->get_fill_css( 'main_header_submenu_color', '#212121', '.site-header .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-ul .emoza-dropdown-li > .dropdown-symbol svg' );
				$css .= $this->get_fill_css( 'main_header_submenu_color_hover', '#757575', '.site-header .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-ul .emoza-dropdown-li:hover > .dropdown-symbol svg' );
				...
				if( $sticky_header ) {
					...
					$css .= '@media only screen and (min-width: 1025px) {';
						...
						// text color
						$css .= $this->get_color_css( 'main_header_sticky_active_color', '', ".sticky-header-active .sticky-header $site_header_inner_selector .site-title a, .sticky-header-active .sticky-header $site_header_inner_selector .site-description, .sticky-header-active .sticky-header $site_header_inner_selector .emoza-dropdown .menu > .emoza-dropdown-li > .emoza-dropdown-link, .sticky-header-active .sticky-header $site_header_inner_selector .header-contact a, .sticky-header-active .sticky-header .header-login-register>a", true );
						...
						$css .= $this->get_background_color_css( 'main_header_sticky_active_color', '', ".sticky-header-active .sticky-header $site_header_inner_selector .emoza-image.is-svg" );

						// text color hover
						$css .= $this->get_color_css( 'main_header_sticky_active_color_hover', '', ".sticky-header-active .sticky-header $site_header_inner_selector .site-title a:hover, .sticky-header-active .sticky-header $site_header_inner_selector .emoza-dropdown .menu > .emoza-dropdown-li:hover > .emoza-dropdown-link, .sticky-header-active .sticky-header $site_header_inner_selector .header-contact a:hover, .sticky-header-active .sticky-header .header-login-register>a:hover", true );
						...
						$css .= $this->get_fill_css( 'main_header_sticky_active_color_hover', '', ".sticky-header-active .sticky-header $site_header_inner_selector .emoza-dropdown .menu > .emoza-dropdown-li:hover > .dropdown-symbol svg, .sticky-header-active .sticky-header $site_header_inner_selector .header-item:not(.header-contact):hover svg:not(.stroke-based)" );
						...
						$css .= $this->get_background_color_css( 'main_header_sticky_active_color_hover', '', ".sticky-header-active .sticky-header $site_header_inner_selector .emoza-image.is-svg:hover" );

						// Submenu 
						$css .= $this->get_background_color_css( 'main_header_sticky_active_submenu_background_color', '#FFF', ".sticky-header-active .sticky-header $site_header_inner_selector .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-ul .emoza-dropdown-li, .header-login-register nav" );
						$css .= $this->get_color_css( 'main_header_sticky_active_submenu_color', '#212121', ".sticky-header-active .sticky-header $site_header_inner_selector .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-ul .emoza-dropdown-li > .emoza-dropdown-link, .header-login-register nav>a", true );
						$css .= $this->get_fill_css( 'main_header_sticky_active_submenu_color', '#212121', ".sticky-header-active .sticky-header $site_header_inner_selector .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-ul .emoza-dropdown-li > .dropdown-symbol svg" );
						$css .= $this->get_fill_css( 'main_header_sticky_active_submenu_color_hover', '#757575', ".sticky-header-active .sticky-header $site_header_inner_selector .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-ul .emoza-dropdown-li:hover > .dropdown-symbol svg" );
						$css .= $this->get_color_css( 'main_header_sticky_active_submenu_color_hover', '#757575', ".sticky-header-active .sticky-header $site_header_inner_selector .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-ul .emoza-dropdown-li:hover > .emoza-dropdown-link, .header-login-register nav>a:hover", true );
				...
				if( 'header_layout_6' === $header_layout ) {
					...
					$css .= '.header_layout_6 .emoza-desktop-offcanvas > .row > div { margin-top: '. esc_attr( $main_header_areas_spacing_l6 ) .'px; }';
					...
					$css .= '.header_layout_6 .emoza-desktop-offcanvas { padding: '. esc_attr( $main_header_padding ) .'px; }';
				}
				...
				if( 'header_layout_7' === $header_layout || 'header_layout_8' === $header_layout ) {
					...
					$css .= $this->get_background_color_css( 'desktop_offcanvas_menu_background_color', '#FFF', '.emoza-desktop-offcanvas' );
					$css .= '.header_layout_7 .emoza-desktop-offcanvas, .header_layout_8 .emoza-desktop-offcanvas { padding: '. esc_attr( $desktop_offcanvas_padding ) .'px; }';
					$css .= '.header_layout_7 .emoza-desktop-offcanvas > .row > div, .header_layout_8 .emoza-desktop-offcanvas > .row > div { margin-top: '. esc_attr( $desktop_offcanvas_content_areas_spacing ) .'px; }';
					$css .= '.header_layout_7 .emoza-desktop-offcanvas .header-item, .header_layout_8 .emoza-desktop-offcanvas .header-item { margin-bottom: '. esc_attr( $header_components_desktop_offcanvas_elements_spacing ) .'px; }';
					$css .= '.header_layout_7 .emoza-desktop-offcanvas .header-item.header-contact a + a, .header_layout_8 .emoza-desktop-offcanvas .header-item.header-contact a + a { margin-top: '. esc_attr( $header_components_desktop_offcanvas_elements_spacing ) .'px; }';
					$css .= '.header_layout_7 .emoza-desktop-offcanvas .emoza-dropdown .menu > .emoza-dropdown-li > .emoza-dropdown-link, .header_layout_8 .emoza-desktop-offcanvas .emoza-dropdown .menu > .emoza-dropdown-li > .emoza-dropdown-link { padding-top: '. esc_attr( $desktop_offcanvas_menu_link_spacing ) .'px; padding-bottom: '. esc_attr( $desktop_offcanvas_menu_link_spacing ) .'px; }';
					...
					if( $desktop_offcanvas_menu_link_separator ) {
						...
						$css .= '.header_layout_7 .emoza-desktop-offcanvas .emoza-dropdown .menu > .emoza-dropdown-li + .emoza-dropdown-li, .header_layout_8 .emoza-desktop-offcanvas .emoza-dropdown .menu > .emoza-dropdown-li + .emoza-dropdown-li { border-top: 1px solid '. esc_attr( self::get_instance()->to_rgba( $desktop_offcanvas_link_separator_color, '0.1' ) ) .'; }';
					}

					$css .= $this->get_color_css( 'desktop_offcanvas_menu_text_color', '#212121', '.emoza-desktop-offcanvas .emoza-dropdown .menu .emoza-dropdown-li .emoza-dropdown-link, .emoza-desktop-offcanvas .site-title a, .emoza-desktop-offcanvas .site-description .emoza-desktop-offcanvas .header-contact a' );
					$css .= '.emoza-desktop-offcanvas .emoza-dropdown .menu li a:hover, .emoza-desktop-offcanvas .header-contact a:hover { color: '. esc_attr( self::get_instance()->to_rgba( $desktop_offcanvas_menu_text_color, '0.7' ) ) .'; }';
					$css .= $this->get_fill_css( 'desktop_offcanvas_menu_text_color', '#212121', '.emoza-desktop-offcanvas .header-item svg:not(.stroke-based), .emoza-desktop-offcanvas .dropdown-symbol .ws-svg-icon svg, .desktop-menu-close svg' );
					$css .= $this->get_stroke_css( 'desktop_offcanvas_menu_text_color', '#212121', '.emoza-desktop-offcanvas .header-item svg.stroke-based' );             
				}
			}

			$css .= $this->get_background_color_rgba_css( 'color_body_text', '#212121', '.site-header-cart .widget_shopping_cart .widgettitle:after, .site-header-cart .widget_shopping_cart .woocommerce-mini-cart__buttons:before, .site-header-cart .widget_shopping_cart .emoza-woocommerce-mini-cart__cross-sell:before', '0.1' );

			//Mobile menu
			$mobile_menu_alignment = get_theme_mod( 'mobile_menu_alignment', 'left' );
			$css .= ".emoza-offcanvas-menu .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-li { text-align:" . esc_attr( $mobile_menu_alignment ) . ";}" . "\n";
			...
			if ( $mobile_menu_link_separator ) {
				$css .= ".emoza-offcanvas-menu .emoza-dropdown .emoza-dropdown-ul .emoza-dropdown-li { padding-top:5px;border-bottom: " . intval( $mobile_header_separator_width ) . "px solid " . esc_attr( $link_separator_color ) . ";}" . "\n";
			}

			$mobile_menu_link_spacing = get_theme_mod( 'mobile_menu_link_spacing', 20 );
			$css .= ".emoza-offcanvas-menu .emoza-dropdown .emoza-dropdown-link { padding:" . esc_attr( $mobile_menu_link_spacing )/2 . "px 0;}" . "\n";

			$mobile_menu_elements_spacing = get_theme_mod( 'mobile_menu_elements_spacing', 20 );
			$css .= ".emoza-offcanvas-menu .header-item + .header-item:not(.separator) { margin-top:" . esc_attr( $mobile_menu_elements_spacing ) . "px;}" . "\n";
			...
			if( $single_post_reading_progress ) {
				...
				$css .= '.emoza-reading-progress__bar { height: '. absint( $single_post_reading_progress_height ) .'px; }';
				$css .= $this->get_background_color_css( 'single_post_reading_progress_background_color', 'transparent', '.emoza-reading-progress' );
				$css .= $this->get_background_color_css( 'single_post_reading_progress_foreground_color', '#212121', '.emoza-reading-progress__bar' );
			}

			// Single post elements divider color
			$css .= $this->get_border_color_rgba_css( 'color_body_text', '#212121', '.emoza-share-box, .emoza-related-posts, .emoza-related-products, .emoza-upsell-products, .emoza-recently-viewed-products, .post-navigation, .single-post-author, .comments-area', 0.1 );
			...
			$css .= ".emoza-wc-product-rating-with-count.wc-block-grid__product-rating { justify-content: flex-start; }"; 
			...
			if ( 'center' === $shop_product_alignment ) {
				...
				$css .= ".emoza-wc-product-rating-with-count.wc-block-grid__product-rating { justify-content: center; }"; 
				...
				$css .= ".products .product .emoza-variation-type-color>a>span, .wc-block-grid__products .wc-block-grid__product .emoza-variation-type-color>a>span { text-indent: 9999px; }";
				$css .= ".emoza-wc-product-rating-with-count.wc-block-grid__product-rating { justify-content: flex-end; }"; 
			}
			...
			if( $wishlist_enable && 'layout1' !== $wishlist_layout ) {
				...
				$css .= $this->get_fill_css( 'shop_product_wishlist_icon_active_color', '#fda5a5', '.emoza-wishlist-button.active svg path' );
				$css .= $this->get_stroke_css( 'shop_product_wishlist_icon_active_color', '#fda5a5', '.emoza-wishlist-button.active svg path' );
				$css .= $this->get_background_color_css( 'shop_product_wishlist_icon_background_color', 'rgba(255,255,255,0)', '.emoza-wishlist-button' );
			} 
			...
			switch ( $single_product_tabs_layout ) {
				case 'style1':
					$css .= $this->get_border_color_css( 'single_product_tabs_border_color_active', '', '.emoza-tabs-style1 .woocommerce-tabs ul.tabs li.active a, .emoza-tabs-style1 .woocommerce-tabs ul.tabs li:hover a' );
					$css .= $this->get_border_bottom_color_rgba_css( 'single_product_tabs_remaining_borders', '#212121', '.emoza-tabs-style1 .woocommerce-tabs ul.tabs', '0.3' );
					break;
				case 'style2':
					$css .= $this->get_border_top_color_css( 'single_product_tabs_border_color_active', '', '.emoza-tabs-style2 .woocommerce-tabs ul.tabs li.active a, .emoza-tabs-style2 .woocommerce-tabs ul.tabs li:hover a' );
					$css .= $this->get_border_color_rgba_css( 'single_product_tabs_remaining_borders', '#212121', '.emoza-tabs-style2 .woocommerce-tabs ul.tabs li a, .emoza-tabs-style2 .woocommerce-tabs ul.tabs, .emoza-tabs-style2 .woocommerce-tabs ul.tabs li:not(.active):not(:hover) a', '0.3' );
					break;  
				case 'style3':
					$css .= $this->get_background_color_rgba_css( 'single_product_tabs_background_color', '#f5f5f5', '.emoza-tabs-style3 .woocommerce-tabs ul.tabs li:not(.active) a, .emoza-tabs-style3 .woocommerce-tabs ul.tabs li:not(.active):hover a', '0.5' );
					$css .= $this->get_background_color_css( 'single_product_tabs_background_color_active', '#f5f5f5', '.emoza-tabs-style3 .woocommerce-tabs ul.tabs li.active a, .emoza-tabs-style3 .woocommerce-tabs ul.tabs li:hover a' );
					$css .= $this->get_border_bottom_color_rgba_css( 'single_product_tabs_remaining_borders', '#212121', '.emoza-tabs-style3 .woocommerce-tabs ul.tabs', '0.3' );
					break;
				case 'style4':
					$css .= $this->get_border_color_css( 'single_product_tabs_border_color_active', '', '.emoza-tabs-style4 .woocommerce-tabs ul.tabs li.active a, .emoza-tabs-style4 .woocommerce-tabs ul.tabs li:hover a' );
					$css .= $this->get_background_color_css( 'single_product_tabs_background_color', '#f5f5f5', '.emoza-tabs-style4 .woocommerce-tabs ul.tabs li:not(.active) a' );
					$css .= $this->get_background_color_css( 'single_product_tabs_background_color_active', '#f5f5f5', '.emoza-tabs-style4 .woocommerce-tabs ul.tabs li.active a' );
					$css .= $this->get_border_color_rgba_css( 'single_product_tabs_remaining_borders', '#212121', '.emoza-tabs-style4 .woocommerce-tabs ul.tabs:before, .emoza-tabs-style4 .woocommerce-tabs ul.tabs li:not(.active) a', '0.3' );
					break;
				case 'style5':
					$color_rgba = self::get_instance()->to_rgba( get_theme_mod( 'single_product_tabs_remaining_borders', '#212121' ), '0.3' );

					$css .= $this->get_background_color_rgba_css( 'single_product_tabs_background_color', '#f5f5f5', '.emoza-tabs-style5 .woocommerce-tabs ul.tabs li:not(.active) a', '0.4' );
					$css .= $this->get_background_color_rgba_css( 'single_product_tabs_background_color_active', '#f5f5f5', '.emoza-tabs-style5 .woocommerce-tabs ul.tabs li.active a, .emoza-tabs-style5 .woocommerce-tabs .panel', '1' );
					$css .= $this->get_border_color_rgba_css( 'single_product_tabs_remaining_borders', '#212121', '.emoza-tabs-style5 .woocommerce-tabs ul.tabs li a, .emoza-tabs-style5 .woocommerce-tabs .panel', '0.3' );
					$css .= '.emoza-tabs-style5 .woocommerce-tabs ul.tabs li:not(.active) a { border-right: 1px solid '.  esc_attr( $color_rgba ) .' }';
					$css .= '.emoza-tabs-style5.emoza-tabs-align-center .woocommerce-tabs ul.tabs li+li a { border-top-color: '.  esc_attr( $color_rgba ) .'; border-right-color: '.  esc_attr( $color_rgba ) .' }';
					break;
					
				case 'style6':
					$css .= $this->get_color_css( 'single_product_tabs_text_color', '#212121', '.emoza-accordion__item>a' );
					$css .= $this->get_border_color_rgba_css( 'single_product_tabs_text_color', '#212121', '.emoza-accordion__item>a:after', 0.5 );
					$css .= $this->get_color_css( 'single_product_tabs_text_color_active', '#212121', '.emoza-accordion__item>a.active, .emoza-accordion__item>a:hover, .emoza-accordion__item>a:focus' );
					$css .= $this->get_border_color_css( 'single_product_tabs_text_color_active', '#212121', '.emoza-accordion__item>a.active:after, .emoza-accordion__item>a:hover:after, .emoza-accordion__item>a:focus:after' );
					$css .= $this->get_border_color_rgba_css( 'single_product_tabs_remaining_borders', '#212121', '.emoza-accordion__item', 0.5 );
					break;
			...
			$single_product_reviews_advanced_enable = Emoza_Modules::is_module_active( 'advanced-reviews' );
			if( $single_product_reviews_advanced_enable ) {
				$css .= $this->get_background_color_css( 'single_product_reviews_advanced_section_bg_color', '#FFF', '.single-product .site-main>.product>section.products.emoza-adv-reviews:after, .emoza-reviews-orderby', true );
				$css .= $this->get_color_css( 'single_product_reviews_advanced_stars_bg_color', '#777', '.star-rating.emoza-star-rating-style2:before, .star-rating::before' );
				$css .= $this->get_color_css( 'single_product_reviews_advanced_stars_color', '#FFA441', '.star-rating.emoza-star-rating-style2 span:before, .star-rating span::before, .emoza-adv-reviews-modal .emoza-adv-reviews-modal-body .emoza-adv-reviews-modal-content .stars:hover a:before' );
				$css .= $this->get_background_color_css( 'color_link_default', '#212121', '.emoza-star-rating-bars .emoza-star-rating-bar-item .item-bar .item-bar-inner' );
				$css .= $this->get_border_color_rgba_css( 'color_body_text', '#212121', '.emoza-reviews-list-wrapper .emoza-reviews-list-item+.emoza-reviews-list-item', 0.15 );
			}

			// Single Product - Product Navigation
			$single_product_navigation = get_theme_mod( 'single_product_navigation', 0 );
			if( $single_product_navigation ) {
				$css .= $this->get_border_bottom_color_rgba_css( 'color_heading_4', '#212121', '.emoza-product-navigation a span:after' );
			}
			...
			$single_sticky_add_to_cart = Emoza_Modules::is_module_active( 'sticky-add-to-cart' );

			if( $single_sticky_add_to_cart ) {
				$css .= $this->get_border_color_rgba_css( 'single_sticky_add_to_cart_style_color_border', '', '.emoza-single-sticky-add-to-cart-wrapper', 0.1 );
				$css .= $this->get_background_color_css( 'single_sticky_add_to_cart_style_color_background', '', '.emoza-single-sticky-add-to-cart-wrapper, .emoza-single-sticky-add-to-cart-wrapper input[type="number"], .emoza-single-sticky-add-to-cart-wrapper select' );
				$css .= $this->get_color_css( 'single_sticky_add_to_cart_style_color_title', '', '.emoza-single-sticky-add-to-cart-wrapper h5' );
				$css .= $this->get_color_css( 'single_sticky_add_to_cart_style_color_content', '', '.emoza-single-sticky-add-to-cart-wrapper .price, .emoza-single-sticky-add-to-cart-wrapper .emoza-single-sticky-add-to-cart-wrapper-content .variations_form table.variations .label, .emoza-single-sticky-add-to-cart-wrapper select, .emoza-single-sticky-add-to-cart-wrapper .emoza-variations-wrapper .emoza-variation-type-button>a, .emoza-single-sticky-add-to-cart-wrapper .quantity .emoza-quantity-plus, .emoza-single-sticky-add-to-cart-wrapper .quantity .emoza-quantity-minus, .emoza-single-sticky-add-to-cart-wrapper .qty, .emoza-single-sticky-add-to-cart-wrapper table.variations .reset_variations' );
				$css .= $this->get_border_color_css( 'single_sticky_add_to_cart_style_color_content', '', '.emoza-single-sticky-add-to-cart-wrapper select, .emoza-single-sticky-add-to-cart-wrapper .emoza-variations-wrapper .emoza-variation-type-button>a, .emoza-single-sticky-add-to-cart-wrapper .quantity' );
				$css .= '.emoza-single-sticky-add-to-cart-wrapper .price del { color: '. esc_attr( get_theme_mod( 'single_sticky_add_to_cart_style_color_content', '#212121' ) ) .'; opacity: 0.8; }';

				$margin_side = is_rtl() ? 'left' : 'right';
				$css .= '.emoza-single-sticky-add-to-cart-wrapper .emoza-single-sticky-add-to-cart-wrapper-content .emoza-single-sticky-add-to-cart-item { margin-'. esc_attr( $margin_side ) .': '. esc_attr( $single_sticky_add_to_cart_elements_spacing ) .'px; }';
			}

			//Side Mini Cart
			$mini_cart_style = get_theme_mod( 'mini_cart_style', 'default' );
			if( $mini_cart_style === 'side' ) {
				$css .= $this->get_background_color_rgba_css( 'color_body_text', '#212121', '.emoza-side-mini-cart .widget_shopping_cart .woocommerce-mini-cart__buttons:before, .emoza-side-mini-cart .widget_shopping_cart .emoza-woocommerce-mini-cart__cross-sell:before', '0.1' );
			}
			...
			if( 'layout3' === $shop_checkout_layout ) {
				$css .= $this->get_background_color_rgba_css( 'color_body_text', '#212121', '.emoza-mstepc-wrapper .divider', '0.1', true );
				$css .= '.emoza-mstepc-wrapper .emoza-mstepc-tabs-nav .emoza-mstepc-tabs-nav-item:before { border-top-color: '. esc_attr( self::get_instance()->to_rgba( get_theme_mod( 'color_body_text', '#212121' ), '0.1' ) ) .' }';
			}
			...
			switch ( $shop_general_quantity_style ) {
				case 'style2':
					...
					$css .= $this->get_background_color_css( 'button_background_color', '', '.quantity-button-style2 .emoza-quantity-plus:hover, .quantity-button-style2 .emoza-quantity-minus:hover' );
					$css .= $this->get_color_css( 'button_color', '', '.quantity-button-style2 .emoza-quantity-plus:hover, .quantity-button-style2 .emoza-quantity-minus:hover' );
					$css .= $this->get_border_color_rgba_css( 'color_body_text', '', '.quantity-button-style2 .quantity, .quantity-button-style2 .emoza-quantity-plus, .quantity-button-style2 .emoza-quantity-minus', 0.3 );
					break;

				case 'style4':
					$css .= $this->get_border_color_rgba_css( 'color_body_text', '', '.quantity-button-style4 .quantity', 0.1 );
					$css .= $this->get_background_color_css( 'button_background_color', '', '.quantity-button-style4 .quantity .emoza-quantity-plus, .quantity-button-style4 .quantity .emoza-quantity-minus' );
					$css .= $this->get_background_color_css( 'button_background_color_hover', '', '.quantity-button-style4 .quantity .emoza-quantity-plus:hover, .quantity-button-style4 .quantity .emoza-quantity-minus:hover' );
					$css .= $this->get_color_css( 'button_color', '', '.quantity-button-style4 .quantity .emoza-quantity-plus, .quantity-button-style4 .quantity .emoza-quantity-minus' );
					break;

				case 'style5':
					$css .= $this->get_background_color_rgba_css( 'content_cards_background', '', '.quantity-button-style5 .quantity .emoza-quantity-plus:hover, .quantity-button-style5 .quantity .emoza-quantity-minus:hover', 0.3 );
					$css .= $this->get_color_css( 'color_body_text', '', '.quantity .emoza-quantity-plus, .quantity .emoza-quantity-minus' );
					break;

				case 'style6':
					$css .= $this->get_background_color_rgba_css( 'content_cards_background', '', '.quantity-button-style6 .quantity .emoza-quantity-plus:hover, .quantity-button-style6 .quantity .emoza-quantity-minus:hover', 0.3 );
					$css .= $this->get_color_css( 'color_body_text', '', '.quantity .emoza-quantity-plus, .quantity .emoza-quantity-minus' );
					$css .= $this->get_border_color_rgba_css( 'color_body_text', '', '.quantity-button-style6 .quantity .qty, .quantity-button-style6 .quantity .emoza-quantity-plus, .quantity-button-style6 .quantity .emoza-quantity-minus', 0.3 );
					break;

				case 'style7':
					$css .= $this->get_border_color_rgba_css( 'color_body_text', '', '.quantity-button-style7 .quantity', 0.3 );
					$css .= $this->get_border_color_css( 'button_color', '', '.quantity-button-style-arrows .emoza-quantity-plus:before, .quantity-button-style-arrows .emoza-quantity-minus:before' );
					$css .= $this->get_background_color_css( 'button_background_color', '', '.quantity-button-style7 .quantity .emoza-quantity-plus, .quantity-button-style7 .quantity .emoza-quantity-minus' );
					break;

				case 'style8':
					$css .= $this->get_border_color_rgba_css( 'color_body_text', '', '.quantity-button-style8 .quantity', 0.5 );
					$css .= $this->get_background_color_css( 'button_background_color', '', '.quantity-button-style8 .quantity .emoza-quantity-plus, .quantity-button-style8 .quantity .emoza-quantity-minus' );
					$css .= $this->get_background_color_css( 'button_background_color_hover', '', '.quantity-button-style8 .quantity .emoza-quantity-plus:hover, .quantity-button-style8 .quantity .emoza-quantity-minus:hover' );
					$css .= $this->get_color_css( 'button_color', '', '.quantity-button-style8 .quantity .emoza-quantity-plus, .quantity-button-style8 .quantity .emoza-quantity-minus' );
					break;
			...
			if( $login_register_popup ) {
				$css .= '.emoza-popup-wrapper { background-color: #'. esc_attr( $background_color ) .'; }';
			}

			// Modal Popup
			$modal_popup_enable = Emoza_Modules::is_module_active( 'modal-popup' );
			if( $modal_popup_enable ) {
				$css .= $this->get_max_width_css( 'modal_popup_max_width', $defaults = array( 'desktop' => 800, 'tablet' => 550, 'mobile' => 300 ), '#modalPopup .emoza-popup-wrapper' );
				$css .= '@media(min-width: 1025px) { #modalPopup .emoza-popup-wrapper__content-side-image { max-width: '. esc_attr( get_theme_mod( 'modal_popup_side_image_max_width_desktop', 40 ) ) .'%; } }';
				$css .= '.emoza-popup-wrapper { background-color: #'. esc_attr( $background_color ) .'; }';    
			}
			...
			$css .= $this->get_border_color_css( 'color_link_default', '#212121', '.shop-table-layout2 .shop_table .emoza-qty-remove-wrapper .remove:after' );
			...
			if ( in_array( $site_layout, array( 'default', 'boxed', 'padded' ) ) ) {
				$css .= $this->get_variable_css( 'content_max_width', 1140, ':root', 'emoza_content_width', 'px' );
			}

			// Boxed
			if ( $site_layout === 'boxed' ) {
				$css .= $this->get_variable_css( 'boxed_max_width', 1000, ':root', 'emoza_boxed_width', 'px' );
			}

			// Padded
			if ( $site_layout === 'padded' ) {
				$css .= $this->get_variable_css( 'background_color', '#ffffff', ':root', 'emoza_background_color' );
				$css .= $this->get_responsive_variable_css( 'padded_layout_spacing', array( 'desktop' => 20, 'tablet' => 10, 'mobile' => 10 ), ':root', 'emoza_padded_spacing', 'px' );
			}

			// Fluid
			if ( $site_layout === 'fluid' ) {
				$css .= $this->get_responsive_variable_css( 'fluid_layout_spacing', array( 'desktop' => 15, 'tablet' => 15, 'mobile' => 15 ), ':root', 'emoza_fluid_spacing', 'px' );
			}
		...
		public function print_styles() {
			...
			wp_localize_script( 'emoza-customizer', 'emoza_theme_options', $this->customizer_js );
			wp_localize_script( 'emoza-customizer', 'emoza_theme_options_css_vars', $this->customizer_js_css_vars );
		}
		...
		public function init() {
			if ( get_transient( 'emoza_update_custom_css_flag' ) ) {
				$this->update_custom_css_file();
				delete_transient( 'emoza_update_custom_css_flag' );
			}
