<div class="emoza-dashboard-card emoza-dashboard-card-no-box-shadow">
    <div class="emoza-dashboard-card-inner-header bt-mb-10px">
        <h2 class="bt-font-size-20px bt-mb-10px bt-mt-0"><?php echo esc_html__( 'Customization Settings', 'emoza-woocommerce' ); ?></h2>
    ...
    <a href="<?php echo esc_url( $this->settings['pf_upgrade_pro'] ); ?>" class="button button-primary btsf-save-settings emoza-dashboard-pro-tooltip" data-tooltip-message="<?php echo esc_attr__( 'This is only available on Emoza Pro', 'emoza-woocommerce' ); ?>" target="_blank" style="max-width: 150px;">
        Save settings
