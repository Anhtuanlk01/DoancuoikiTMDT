    ...
    <div class="emoza-dashboard-card-body emoza-dashboard-card-body-content-with-dividers">
        ...
        <?php if ( defined( 'EMOZA_PRO_VERSION' ) ) : ?>
            ...
            <div class="emoza-dashboard-license-wrapper">
                <h2 class="bt-mb-10px"><?php echo esc_html__( 'Emoza Pro License', 'emoza-woocommerce' ); ?></h2>
                <p class="bt-text-color-grey bt-mb-20px"><?php echo esc_html__( 'Activate your license key for Emoza Pro to get the latest plugin updates automatically right from your WordPress Dashboard.', 'emoza-woocommerce' ); ?> </p>
                <?php 
                /**
                ...
                <div class="emoza-dashboard-content-expand bt-mt-20px" data-bt-toggle-expand style="max-width: 360px;">
                    ...
                    <div class="emoza-dashboard-content-expand-content bt-toggle-expand-content">
                        <ul class="emoza-dashboard-content-expand-list">
                            <li>
                                ...
                                printf(
                                    ...
                                    esc_html__( 'To get your key, please login to your %1$sEmoza account%2$s.', 'emoza-woocommerce' ),
                                    '<a href="https://www.emoza.org/" target="_blank">',
                                    '</a>'
                                ); ?>
                            </li>
                            <li>
