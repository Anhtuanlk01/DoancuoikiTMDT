<div class="emoza-dashboard-card emoza-dashboard-card-no-box-shadow">
    <div class="emoza-dashboard-card-inner-header bt-mb-10px">
        <h2 class="bt-font-size-20px bt-mb-10px bt-mt-0"><?php echo esc_html__( 'Filter Presets', 'emoza-woocommerce' ); ?></h2>
    ...
    <div class="bt-presets-list">
        ...
        <div class="bt-presets-list__body">
            <div class="bt-presets-list__item">
                ...
                <p class="bt-presets-list__item-shortcode">[emoza_shop_filters-preset-0ugb9]</p>
        ...
        <a href="<?php echo esc_url( $this->settings['pf_upgrade_pro'] ); ?>" class="button button-secondary bt-presets-list__add-button emoza-dashboard-pro-tooltip has-icon has-icon-blue" data-tooltip-message="<?php echo esc_attr__( 'This is only available on Emoza Pro', 'emoza-woocommerce' ); ?>" target="_blank">
            + Add new preset
            <?php emoza_get_svg_icon( 'icon-lock-outline', true ); ?>
        </a>
    </div>
    <hr class="emoza-dashboard-divider">
    <a href="<?php echo esc_url( $this->settings['pf_upgrade_pro'] ); ?>" class="button button-primary btsf-save-settings emoza-dashboard-pro-tooltip has-icon" data-tooltip-message="<?php echo esc_attr__( 'This is only available on Emoza Pro', 'emoza-woocommerce' ); ?>" target="_blank" style="max-width: 150px;">
        Save settings
        <?php emoza_get_svg_icon( 'icon-lock-outline', true ); ?>
    </a>
</div>