...
function emoza_woocommerce_before_quantity_input_field() {
	echo '<a href="#" class="emoza-quantity-minus" title="' . esc_attr__( 'Decrease quantity', 'emoza-woocommerce' ) . '" role="button">'. esc_html( emoza_get_quantity_symbols_output( 'minus' ) ) .'<span class="bt-d-none">'. esc_html__( 'Decrease product quantity.', 'emoza-woocommerce' ) .'</span></a>';
}
...
function emoza_woocommerce_after_quantity_input_field() {
	echo '<a href="#" class="emoza-quantity-plus" title="' . esc_attr__( 'Increase quantity', 'emoza-woocommerce' ) . '" role="button">'. esc_html( emoza_get_quantity_symbols_output( 'plus' ) ) .'<span class="bt-d-none">'. esc_html__( 'Increase product quantity.', 'emoza-woocommerce' ) .'</span></a>';
}
...
function emoza_cart_backorder_notification( $message, $product_id ){
	...
	$new_default_message = sprintf( '<small class="bt-d-block bt-m-0">%1$s</small>', __( 'Available on backorder', 'emoza-woocommerce' ) );
	...
	if ( $stock_quantity > 0 ) {
		return sprintf( '<small class="bt-d-block bt-m-0">%1$s %2$s</small>', absint( $stock_quantity ), __( 'in stock. Remaining is available on backorder.', 'emoza-woocommerce' ) );
	}
