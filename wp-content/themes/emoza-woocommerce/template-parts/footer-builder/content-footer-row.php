...
$bhfb = Emoza_Header_Footer_Builder::get_instance(); 
...
$columns_layout  = Emoza_Header_Footer_Builder::get_columns_layout_class( get_theme_mod( "emoza_footer_row__{$row}_columns_layout_desktop", Emoza_Header_Footer_Builder::get_row_columns_layout_default_customizer_value( $row ) ) ); 
$row_empty_class = Emoza_Header_Footer_Builder::is_row_empty( $row_data->$device ) ? ' bhfb-is-row-empty' : ''; ?>
...
<div class="<?php echo esc_attr( $container ); ?>">
    <div class="bhfb-row bhfb-cols-<?php echo esc_attr( $cols_number ); echo ' ' .  esc_attr( $columns_layout ); echo esc_attr( $row_empty_class ); ?>">
        ...
        foreach( $row_data->$device as $col_id => $elements ) :
            ...
            $column_option_id     = 'emoza_footer_row__'. $row .'_column' . ( $col_id + 1 );
            ...
            <div class="<?php echo implode( ' ', $column_classes ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
                ...
                <?php Emoza_Header_Footer_Builder::customizer_edit_column_button( 'footer', $row, $col_id + 1 ); ?>
