...
(function ($) {
  ...
  wp.customize('mobile_menu_alignment', function (value) {
    value.bind(function (to) {
      $('.emoza-offcanvas-menu .emoza-dropdown ul li').css('text-align', to);
    });
  });
  wp.customize('mobile_menu_link_spacing', function (value) {
    value.bind(function (to) {
      $('.emoza-offcanvas-menu .emoza-dropdown a').css('padding-top', to / 2);
      $('.emoza-offcanvas-menu .emoza-dropdown a').css('padding-bottom', to / 2);
    });
  });
  wp.customize('mobile_menu_elements_spacing', function (value) {
    value.bind(function (to) {
      $('.emoza-offcanvas-menu .header-item + .header-item:not(.separator)').css('margin-top', to + 'px');
    });
  });
  ...
  wp.customize('mobile_header_separator_width', function (value) {
    value.bind(function (to) {
      $('.emoza-offcanvas-menu .emoza-dropdown ul li').css('border-bottom-width', to + 'px');
    });
  });
  wp.customize('main_header_areas_spacing_l6', function (value) {
    value.bind(function (to) {
      $('.header_layout_6 .emoza-desktop-offcanvas > .row > div').css({
        'margin-top': to + 'px'
      });
    });
  });
  ...
  wp.customize('main_header_padding', function (value) {
    value.bind(function (to) {
      $('.header_layout_6 .emoza-desktop-offcanvas').css({
        padding: to + 'px'
      });
    });
  });
  wp.customize('desktop_offcanvas_padding', function (value) {
    value.bind(function (to) {
      $('.header_layout_7 .emoza-desktop-offcanvas, .header_layout_8 .emoza-desktop-offcanvas').css({
        padding: to + 'px'
      });
    });
  });
  wp.customize('desktop_offcanvas_menu_link_spacing', function (value) {
    value.bind(function (to) {
      $('.header_layout_7 .emoza-desktop-offcanvas .emoza-dropdown .menu > li > a, .header_layout_8 .emoza-desktop-offcanvas .emoza-dropdown .menu > li > a').css({
        'padding-top': to + 'px',
  ...
  wp.customize('desktop_offcanvas_link_separator_color', function (value) {
    value.bind(function (to) {
      ...
      if (desktop_offcanvas_menu_link_separator) {
        $('.header_layout_7 .emoza-desktop-offcanvas .emoza-dropdown .menu > li + li, .header_layout_8 .emoza-desktop-offcanvas .emoza-dropdown .menu > li + li').css({
  ...
  wp.customize('desktop_offcanvas_content_areas_spacing', function (value) {
    value.bind(function (to) {
      $('.header_layout_7 .emoza-desktop-offcanvas > .row > div ,.header_layout_8 .emoza-desktop-offcanvas > .row > div').css({
        'margin-top': to + 'px'
      });
    });
  });
  wp.customize('header_components_desktop_offcanvas_elements_spacing', function (value) {
    value.bind(function (to) {
      $('.header_layout_7 .emoza-desktop-offcanvas .header-item, .header_layout_8 .emoza-desktop-offcanvas .header-item').css({
        'margin-bottom': to + 'px'
      });
      $('.header_layout_7 .emoza-desktop-offcanvas .header-item.header-contact a + a, .header_layout_8 .emoza-desktop-offcanvas .header-item.header-contact a + a').css({
        'margin-top': to + 'px'
      });
    });
  });
  ...
  $.each($devices, function (device, mediaSize) {
    wp.customize('scrolltop_side_offset' + '_' + device, function (value) {
      value.bind(function (to) {
        $('head').find('#emoza-customizer-styles-scrolltop_side_offset_' + device).remove();
        ...
        $('head').append('<style id="emoza-customizer-styles-scrolltop_side_offset_' + device + '">' + output + '</style>');
      });
    });
    wp.customize('scrolltop_bottom_offset' + '_' + device, function (value) {
      value.bind(function (to) {
        $('head').find('#emoza-customizer-styles-scrolltop_bottom_offset_' + device).remove();
        var output = '@media ' + mediaSize + ' { .back-to-top.display { bottom:' + to + 'px; } }';
        $('head').append('<style id="emoza-customizer-styles-scrolltop_bottom_offset_' + device + '">' + output + '</style>');
      });
    });
  });
    ...
    if ($section.find('#customize-control-single_product_elements_order').length) {
      wp.customize('shop_product_wishlist_layout', function (value) {
        if ('layout1' === value.get()) {
          $section.find('#customize-control-single_product_elements_order .kirki-sortable-item[data-value="emoza_single_wishlist_button"]').css('display', 'none');
        } else {
          $section.find('#customize-control-single_product_elements_order .kirki-sortable-item[data-value="emoza_single_wishlist_button"]').css('display', 'block');
        }
      });
    }
  });
  ...
  wp.customize('single_product_gallery_styles_background_color', function (value) {
    value.bind(function (to) {
      $('head').find('#emoza-customizer-styles-single_product_gallery_styles_background_color').remove();
      var output = '';
      ...
      if (output) {
        $('head').append('<style id="emoza-customizer-styles-single_product_gallery_styles_background_color">' + output + '</style>');
      }
    });
  });
  ...
  wp.customize('single_product_tabs_border_color_active', function (value) {
    value.bind(function (to) {
      ...
      $('head').find('#emoza-customizer-styles-single_product_tabs_border_color_active').remove();
      var output = '';
      switch (single_product_tabs_layout) {
        case 'style1':
        case 'style4':
          output += '.emoza-tabs-style1 .woocommerce-tabs ul.tabs li.active a, .emoza-tabs-style1 .woocommerce-tabs ul.tabs li:hover a, .emoza-tabs-style4 .woocommerce-tabs ul.tabs li.active a, .emoza-tabs-style4 .woocommerce-tabs ul.tabs li:hover a { border-color: ' + to + ' !important; }';
          break;
        case 'style2':
          output += '.emoza-tabs-style2 .woocommerce-tabs ul.tabs li.active a, .emoza-tabs-style2 .woocommerce-tabs ul.tabs li:hover a { border-top-color: ' + to + ' !important; }';
          break;
        default:
          output = '';
          break;
      ...
      if (output) {
        $('head').append('<style id="emoza-customizer-styles-single_product_tabs_border_color_active">' + output + '</style>');
      }
    });
  });
  wp.customize('single_product_tabs_background_color', function (value) {
    value.bind(function (to) {
      var single_product_tabs_layout = window.parent.window.wp.customize.control('single_product_tabs_layout').setting.get();
      $('head').find('#emoza-customizer-styles-single_product_tabs_background_color').remove();
      var output = '';
      switch (single_product_tabs_layout) {
        case 'style3':
          output += '.emoza-tabs-style3 .woocommerce-tabs ul.tabs li:not(.active) a, .emoza-tabs-style3 .woocommerce-tabs ul.tabs li:not(.active):hover a { background-color: ' + hexToRGB(to, 0.5) + ' !important; }';
          break;
        case 'style4':
          output += '.emoza-tabs-style4 .woocommerce-tabs ul.tabs li:not(.active) a { background-color: ' + to + ' !important; }';
          break;
        case 'style5':
          output += '.emoza-tabs-style5 .woocommerce-tabs ul.tabs li:not(.active) a { background-color: ' + hexToRGB(to, 0.4) + ' !important; }';
          break;
        default:
          output = '';
          break;
      ...
      if (output) {
        $('head').append('<style id="emoza-customizer-styles-single_product_tabs_background_color">' + output + '</style>');
      }
    });
  });
  wp.customize('single_product_tabs_background_color_active', function (value) {
    value.bind(function (to) {
      var single_product_tabs_layout = window.parent.window.wp.customize.control('single_product_tabs_layout').setting.get();
      $('head').find('#emoza-customizer-styles-single_product_tabs_background_color_active').remove();
      var output = '';
      switch (single_product_tabs_layout) {
        case 'style3':
          output += '.emoza-tabs-style3 .woocommerce-tabs ul.tabs li.active a, .emoza-tabs-style3 .woocommerce-tabs ul.tabs li:hover a { background-color: ' + to + ' !important; }';
          break;
        case 'style4':
          output += '.emoza-tabs-style4 .woocommerce-tabs ul.tabs li.active a { background-color: ' + to + ' !important; }';
          break;
        case 'style5':
          output += '.emoza-tabs-style5 .woocommerce-tabs ul.tabs li.active a, .emoza-tabs-style5 .woocommerce-tabs .panel { background-color: ' + hexToRGB(to, 1) + ' !important; }';
          break;
        default:
          output = '';
          break;
      ...
      if (output) {
        $('head').append('<style id="emoza-customizer-styles-single_product_tabs_background_color_active">' + output + '</style>');
      }
    });
  });
  wp.customize('single_product_tabs_text_color', function (value) {
    value.bind(function (to) {
      $('head').find('#emoza-customizer-styles-single_product_tabs_text_color').remove();
      var output = '.woocommerce-tabs ul.tabs li:not(.active) a ,.woocommerce-tabs ul.tabs li:not(.active) a:hover { color: ' + to + ' !important; }';
      if (output) {
        $('head').append('<style id="emoza-customizer-styles-single_product_tabs_text_color">' + output + '</style>');
      }
    });
  });
  wp.customize('single_product_tabs_text_color_active', function (value) {
    value.bind(function (to) {
      $('head').find('#emoza-customizer-styles-single_product_tabs_text_color_active').remove();
      var output = '.woocommerce-tabs ul.tabs li.active a,.woocommerce-tabs ul.tabs li.active a:hover { color: ' + to + ' !important; }';
      if (output) {
        $('head').append('<style id="emoza-customizer-styles-single_product_tabs_text_color_active">' + output + '</style>');
      }
    });
  });
  wp.customize('single_product_tabs_remaining_borders', function (value) {
    value.bind(function (to) {
      var single_product_tabs_layout = window.parent.window.wp.customize.control('single_product_tabs_layout').setting.get();
      $('head').find('#emoza-customizer-styles-single_product_tabs_remaining_borders').remove();
      var output = '';
      switch (single_product_tabs_layout) {
        case 'style2':
          output += '.emoza-tabs-style2 .woocommerce-tabs ul.tabs li a, .emoza-tabs-style2 .woocommerce-tabs ul.tabs, .emoza-tabs-style2 .woocommerce-tabs ul.tabs li:not(.active):not(:hover) a { border-color: ' + hexToRGB(to, 0.3) + ' !important; }';
          break;
        case 'style1':
        case 'style3':
          output += '.emoza-tabs-style1 .woocommerce-tabs ul.tabs, .emoza-tabs-style3 .woocommerce-tabs ul.tabs { border-bottom-color: ' + hexToRGB(to, 0.3) + ' !important; }';
          break;
        case 'style4':
          output += '.emoza-tabs-style4 .woocommerce-tabs ul.tabs:before { border-color: ' + hexToRGB(to, 0.3) + ' !important; } .emoza-tabs-style4 .woocommerce-tabs ul.tabs li:not(.active) a { border-color: ' + hexToRGB(to, 0.3) + ' !important; }';
          break;
        case 'style5':
          output += '.emoza-tabs-style5 .woocommerce-tabs ul.tabs li a, .emoza-tabs-style5 .woocommerce-tabs .panel { border-color: ' + hexToRGB(to, 0.3) + ' !important; } .emoza-tabs-style5 .woocommerce-tabs ul.tabs li:not(.active) a { border-right: 1px solid ' + to + ' }';
          break;
        default:
          output = '';
          break;
      ...
      if (output) {
        $('head').append('<style id="emoza-customizer-styles-single_product_tabs_remaining_borders">' + output + '</style>');
      }
    });
  });
  wp.customize('single_product_tabs_layout', function (value) {
    value.bind(function (layout) {
      $('.site-main').removeClass('emoza-tabs-style1 emoza-tabs-style2 emoza-tabs-style3 emoza-tabs-style4 emoza-tabs-style5');
      $('.site-main').addClass('emoza-tabs-' + layout);
  ...
  wp.customize('single_product_tabs_alignment', function (value) {
    value.bind(function (to) {
      $('.site-main').removeClass('emoza-tabs-align-left emoza-tabs-align-center emoza-tabs-align-right');
      $('.site-main').addClass('emoza-tabs-align-' + to);
  ...
  wp.customize('single_sticky_add_to_cart_elements_spacing', function (value) {
    value.bind(function (to) {
      ...
      $('.emoza-single-sticky-add-to-cart-wrapper .emoza-single-sticky-add-to-cart-wrapper-content .emoza-single-sticky-add-to-cart-item').css("margin-".concat(margin_side), to + 'px');
    });
  });
  ...
  // 	value.bind( function( to ) {
  // 		$( '.emoza-floating-mini-cart-icon').css( 'font-size', to + 'px' );
  // 	} );
  // } );
  ...
  wp.customize('side_mini_cart_floating_icon_position', function (value) {
    value.bind(function (to) {
      ...
      if (to === 'left') {
        $('.emoza-floating-mini-cart-icon').css('bottom', corner_offset + 'px');
        $('.emoza-floating-mini-cart-icon').css('left', corner_offset + 'px');
        $('.emoza-floating-mini-cart-icon').css('right', 'auto');
      } else {
        $('.emoza-floating-mini-cart-icon').css('bottom', corner_offset + 'px');
        $('.emoza-floating-mini-cart-icon').css('right', corner_offset + 'px');
        $('.emoza-floating-mini-cart-icon').css('left', 'auto');
      }
    });
  });
  ...
  $.each($devices, function (device, mediaSize) {
    wp.customize('side_mini_cart_floating_icon_corner_offset' + '_' + device, function (value) {
      value.bind(function (to) {
        $('head').find('#emoza-customizer-styles-side_mini_cart_floating_icon_corner_offset_' + device).remove();
        var output = '@media ' + mediaSize + ' { .emoza-floating-mini-cart-icon { bottom:' + to + 'px; } }';
        if (typeof wp.customize('side_mini_cart_floating_icon_position') !== 'undefined') {
          if (wp.customize('side_mini_cart_floating_icon_position').get() === 'left') {
            $('.emoza-floating-mini-cart-icon').css('left', to + 'px');
            output += '@media ' + mediaSize + ' { .emoza-floating-mini-cart-icon { left:' + to + 'px; } }';
          } else {
            output += '@media ' + mediaSize + ' { .emoza-floating-mini-cart-icon { right:' + to + 'px; } }';
          }
        }
        $('head').append('<style id="emoza-customizer-styles-side_mini_cart_floating_icon_corner_offset_' + device + '">' + output + '</style>');
      });
    });
  });
  ...
  wp.customize('side_mini_cart_floating_icon_border_radius', function (value) {
    value.bind(function (to) {
      $('.emoza-floating-mini-cart-icon .emoza-floating-mini-cart-icon-icon').css('border-radius', to + 'px');
    });
  });
  ...
  wp.customize('side_mini_cart_floating_icon_shadow', function (value) {
    value.bind(function (to) {
      if (to) {
        $('.emoza-floating-mini-cart-icon .emoza-floating-mini-cart-icon-icon').css('box-shadow', 'inset 0 0 2px rgb(0 0 0 / 3%), 0 4px 10px rgb(0 0 0 / 17%)');
      } else {
        $('.emoza-floating-mini-cart-icon .emoza-floating-mini-cart-icon-icon').css('box-shadow', 'none');
      }
    });
  });
  var $topBottPad = {
    "breadcrumbs_padding": ".emoza-breadcrumb-trail",
  ...
  var $marginBottom = {
    "breadcrumbs_margin_bottom": ".emoza-breadcrumb-trail"
  };
  ...
  var $maxWidth = {
    ...
    "modal_popup_max_width": "#modalPopup .emoza-popup-wrapper"
  };
  ...
  var $maxWidthPercent = {
    "modal_popup_side_image_max_width": "#modalPopup .emoza-popup-wrapper__content-side-image"
  };
  ...
  //   var $fontSizes 	= {  "body_font_size":"body","header_menu_font_size":".top-bar .secondary-navigation, #masthead .main-navigation, .emoza-offcanvas-menu .main-navigation, .bottom-header-row .main-navigation, .bhfb-header .main-navigation, .bhfb-header .secondary-navigation","h1_font_size":"h1:not(.site-title)","h2_font_size":"h2","h3_font_size":"h3","h4_font_size":"h4","h5_font_size":"h5","h6_font_size":"h6","single_product_title_size":".product-gallery-summary .entry-title, .emoza-tb-sp-title h1","single_product_price_size":".product-gallery-summary .price","loop_post_text_size":".posts-archive .entry-content","loop_post_meta_size":".posts-archive .entry-meta","loop_post_title_size":".posts-archive .entry-title","single_post_title_size": ".single .entry-header .entry-title","single_post_meta_size": ".single .entry-meta","footer_widgets_title_size":".widget-column .widget .widget-title","shop_product_title_size": shopProductTitleSelector, };
  ...
  wp.customize('emoza_header_menu_font', function (value) {
    value.bind(function (to) {
      $('head').find('#emoza-preview-google-fonts-header-menu-css').remove();
      $('head').append('<link id="emoza-preview-google-fonts-header-menu-css" href="" rel="stylesheet">');
      $('#emoza-preview-google-fonts-header-menu-css').attr('href', 'https://fonts.googleapis.com/css?family=' + jQuery.parseJSON(to)['font'].replace(/ /g, '+') + ':' + jQuery.parseJSON(to)['regularweight'] + '&display=swap');
      $('.top-bar .secondary-navigation, #masthead .main-navigation, .emoza-offcanvas-menu .main-navigation, .bottom-header-row .main-navigation, .bhfb-header .main-navigation, .bhfb-header .secondary-navigation').css('font-family', jQuery.parseJSON(to)['font']);
      $('.top-bar .secondary-navigation, #masthead .main-navigation, .emoza-offcanvas-menu .main-navigation, .bottom-header-row .main-navigation, .bhfb-header .main-navigation, .bhfb-header .secondary-navigation').css('font-weight', jQuery.parseJSON(to)['regularweight']);
    });
  });
  wp.customize('button_font', function (value) {
    value.bind(function (to) {
      $('head').find('#emoza-preview-google-fonts-button-css').remove();
      $('head').append('<link id="emoza-preview-google-fonts-button-css" href="" rel="stylesheet">');
      $('#emoza-preview-google-fonts-button-css').attr('href', 'https://fonts.googleapis.com/css?family=' + jQuery.parseJSON(to)['font'].replace(/ /g, '+') + ':' + jQuery.parseJSON(to)['regularweight'] + '&display=swap');
      $(buttonSelector).css('font-family', jQuery.parseJSON(to)['font']);
      $(buttonSelector).css('font-weight', jQuery.parseJSON(to)['regularweight']);
    });
  });
  wp.customize('loop_post_title_font', function (value) {
    value.bind(function (to) {
      $('head').find('#emoza-preview-google-fonts-loop-post-title-css').remove();
      $('head').append('<link id="emoza-preview-google-fonts-loop-post-title-css" href="" rel="stylesheet">');
      $('#emoza-preview-google-fonts-loop-post-title-css').attr('href', 'https://fonts.googleapis.com/css?family=' + jQuery.parseJSON(to)['font'].replace(/ /g, '+') + ':' + jQuery.parseJSON(to)['regularweight'] + '&display=swap');
      $(loopPostTitleSelector).css('font-family', jQuery.parseJSON(to)['font']);
      $(loopPostTitleSelector).css('font-weight', jQuery.parseJSON(to)['regularweight']);
    });
  });
  ...
  wp.customize('single_post_title_font', function (value) {
    value.bind(function (to) {
      $('head').find('#emoza-preview-google-fonts-single-post-title-css').remove();
      $('head').append('<link id="emoza-preview-google-fonts-single-post-title-css" href="" rel="stylesheet">');
      $('#emoza-preview-google-fonts-single-post-title-css').attr('href', 'https://fonts.googleapis.com/css?family=' + jQuery.parseJSON(to)['font'].replace(/ /g, '+') + ':' + jQuery.parseJSON(to)['regularweight'] + '&display=swap');
      $(singlePostTitleSelector).css('font-family', jQuery.parseJSON(to)['font']);
      $(singlePostTitleSelector).css('font-weight', jQuery.parseJSON(to)['regularweight']);
    });
  });
  ...
  wp.customize('single_product_title_font', function (value) {
    value.bind(function (to) {
      $('head').find('#emoza-preview-google-fonts-single-product-title-css').remove();
      $('head').append('<link id="emoza-preview-google-fonts-single-product-title-css" href="" rel="stylesheet">');
      $('#emoza-preview-google-fonts-single-product-title-css').attr('href', 'https://fonts.googleapis.com/css?family=' + jQuery.parseJSON(to)['font'].replace(/ /g, '+') + ':' + jQuery.parseJSON(to)['regularweight'] + '&display=swap');
      $(singleProductTitleSelector).css('font-family', jQuery.parseJSON(to)['font']);
      $(singleProductTitleSelector).css('font-weight', jQuery.parseJSON(to)['regularweight']);
    });
  });
  ...
  wp.customize('shop_product_title_font', function (value) {
    value.bind(function (to) {
      $('head').find('#emoza-preview-google-fonts-shop-product-title-css').remove();
      $('head').append('<link id="emoza-preview-google-fonts-shop-product-title-css" href="" rel="stylesheet">');
      $('#emoza-preview-google-fonts-shop-product-title-css').attr('href', 'https://fonts.googleapis.com/css?family=' + jQuery.parseJSON(to)['font'].replace(/ /g, '+') + ':' + jQuery.parseJSON(to)['regularweight'] + '&display=swap');
      $(shopProductTitleSelector).css('font-family', jQuery.parseJSON(to)['font']);
      $(shopProductTitleSelector).css('font-weight', jQuery.parseJSON(to)['regularweight']);
    });
  });
  ...
  wp.customize('emoza_headings_custom_font', function (value) {
    value.bind(function (to) {
      var $selector = $('h1,h2,h3,h4,h5,h6,.site-title');
      embedCustomGoogleFonts($selector, 'emoza_headings_custom_font', 'family');
    });
  });
  wp.customize('emoza_headings_custom_font_weight', function (value) {
    value.bind(function (to) {
      var $selector = $('h1,h2,h3,h4,h5,h6,.site-title');
      embedCustomGoogleFonts($selector, 'emoza_headings_custom_font', 'weight');
    });
  });
  wp.customize('emoza_body_custom_font', function (value) {
    value.bind(function (to) {
      var $selector = $('body');
      embedCustomGoogleFonts($selector, 'emoza_body_custom_font', 'family');
    });
  });
  wp.customize('emoza_body_custom_font_weight', function (value) {
    value.bind(function (to) {
      var $selector = $('body');
      embedCustomGoogleFonts($selector, 'emoza_body_custom_font', 'weight');
    });
  });
  wp.customize('emoza_header_menu_custom_font', function (value) {
    value.bind(function (to) {
      var $selector = $('.top-bar .secondary-navigation, #masthead .main-navigation, .emoza-offcanvas-menu .main-navigation, .bottom-header-row .main-navigation, .bhfb-header .main-navigation, .bhfb-header .secondary-navigation');
      embedCustomGoogleFonts($selector, 'emoza_header_menu_custom_font', 'family');
    });
  });
  wp.customize('emoza_header_menu_custom_font_weight', function (value) {
    value.bind(function (to) {
      var $selector = $('.top-bar .secondary-navigation, #masthead .main-navigation, .emoza-offcanvas-menu .main-navigation, .bottom-header-row .main-navigation, .bhfb-header .main-navigation, .bhfb-header .secondary-navigation');
      embedCustomGoogleFonts($selector, 'emoza_header_menu_custom_font', 'weight');
    });
  });
  ...
  wp.customize('emoza_headings_adobe_font', function (value) {
    value.bind(function (to) {
  ...
  wp.customize('emoza_body_adobe_font', function (value) {
    value.bind(function (to) {
      var family = to.split('|')[0],
        weight = to.split('|')[1];
  ...
  wp.customize('emoza_header_menu_adobe_font', function (value) {
    value.bind(function (to) {
      var family = to.split('|')[0],
        weight = to.split('|')[1];
      $('.top-bar .secondary-navigation, #masthead .main-navigation, .emoza-offcanvas-menu .main-navigation, .bottom-header-row .main-navigation, .bhfb-header .main-navigation, .bhfb-header .secondary-navigation').css('font-family', family);
      $('.top-bar .secondary-navigation, #masthead .main-navigation, .emoza-offcanvas-menu .main-navigation, .bottom-header-row .main-navigation, .bhfb-header .main-navigation, .bhfb-header .secondary-navigation').css('font-weight', weight);
    });
  });
  ...
  wp.customize('header_menu_font_style', function (value) {
    value.bind(function (to) {
      $('.top-bar .secondary-navigation, #masthead .main-navigation, .emoza-offcanvas-menu .main-navigation, .bottom-header-row .main-navigation, .bhfb-header .main-navigation, .bhfb-header .secondary-navigation').css('font-style', to);
    });
  });
  wp.customize('header_menu_line_height', function (value) {
    value.bind(function (to) {
      $('.top-bar .secondary-navigation, #masthead .main-navigation, .emoza-offcanvas-menu .main-navigation, .bottom-header-row .main-navigation, .bhfb-header .main-navigation, .bhfb-header .secondary-navigation').css('line-height', to);
    });
  });
  wp.customize('header_menu_letter_spacing', function (value) {
    value.bind(function (to) {
      $('.top-bar .secondary-navigation, #masthead .main-navigation, .emoza-offcanvas-menu .main-navigation, .bottom-header-row .main-navigation, .bhfb-header .main-navigation, .bhfb-header .secondary-navigation').css('letter-spacing', to + 'px');
    });
  });
  wp.customize('header_menu_text_transform', function (value) {
    value.bind(function (to) {
      $('.top-bar .secondary-navigation, #masthead .main-navigation, .emoza-offcanvas-menu .main-navigation, .bottom-header-row .main-navigation, .bhfb-header .main-navigation, .bhfb-header .secondary-navigation').css('text-transform', to);
    });
  });
  wp.customize('header_menu_text_decoration', function (value) {
    value.bind(function (to) {
      $('.top-bar .secondary-navigation, #masthead .main-navigation, .emoza-offcanvas-menu .main-navigation, .bottom-header-row .main-navigation, .bhfb-header .main-navigation, .bhfb-header .secondary-navigation').css('text-decoration', to);
    });
  });
  ...
  wp.customize('breadcrumbs_align', function (value) {
    value.bind(function (to) {
      $('.emoza-breadcrumb-trail').css('text-align', to);
    });
  });
  ...
  wp.customize('modal_popup_content_padding', function (value) {
    value.bind(function (to) {
      $('.emoza-popup-wrapper').css('padding', to + 'px');
    });
  });
  ...
  wp.customize('bhfb_search_form_button_margin_left', function (value) {
    value.bind(function (to) {
      $('head').find('#emoza-customizer-styles-bhfb_search_form_button_margin_left').remove();
      ...
      $('head').append('<style id="emoza-customizer-styles-bhfb_search_form_button_margin_left">' + output + '</style>');
    });
  });

  // wp.customize( 'bhfb_search_form_size', function( value ) {
  // 	value.bind( function( to ) {
  // 		$( '.header-search-form form button, .header-search-form form .search-field, .header-search-form .emoza-select, .header-search-form .emoza-select select' ).css( 'font-size', to + 'rem' );
  // 	} );
  // } );

  wp.customize('bhfb_search_form_input_border_radius', function (value) {
    value.bind(function (to) {
      $('.header-search-form form .search-field, .header-search-form .emoza-select select').css('border-radius', to + 'px');
    });
  });
  ...
  $.each($devices, function (device, mediaSize) {
    wp.customize('bhfb_search_form_width' + '_' + device, function (value) {
      value.bind(function (to) {
        $('head').find('#emoza-customizer-styles-bhfb_search_form_width_' + device).remove();
        var output = '@media ' + mediaSize + ' { .header-search-form { width:' + to + 'px; } }';
        $('head').append('<style id="emoza-customizer-styles-bhfb_search_form_width_' + device + '">' + output + '</style>');
      });
    });
  });
  wp.customize('bhfb_search_form_product_cat_dropdown_margin_right', function (value) {
    value.bind(function (to) {
      $('head').find('#emoza-customizer-styles-bhfb_search_form_product_cat_dropdown_margin_right').remove();
      var output = '.header-search-form .emoza-select { margin-right:' + to + 'px !important; }';
      $('head').append('<style id="emoza-customizer-styles-bhfb_search_form_product_cat_dropdown_margin_right">' + output + '</style>');
    });
  });
  ...
  $.each($devices, function (device, mediaSize) {
    wp.customize('product_swatch_button_left_right_padding_' + device, function (value) {
      value.bind(function (to) {
        $('head').find('#emoza-customizer-styles-' + 'product_swatch_button_left_right_padding_' + device).remove();
        var output = '@media ' + mediaSize + ' { .emoza-variations-wrapper .emoza-variation-type-button > a { padding-left:' + to + 'px !important; padding-right:' + to + 'px !important; } }';
        $('head').append('<style id="emoza-customizer-styles-' + 'product_swatch_button_left_right_padding_' + device + '">' + output + '</style>');
      });
    });
  });
  $.each($devices, function (device, mediaSize) {
    wp.customize('product_swatch_button_top_bottom_padding_' + device, function (value) {
      value.bind(function (to) {
        $('head').find('#emoza-customizer-styles-' + 'product_swatch_button_top_bottom_padding_' + device).remove();
        var output = '@media ' + mediaSize + ' { .emoza-variations-wrapper .emoza-variation-type-button > a { padding-top:' + to + 'px !important; padding-bottom:' + to + 'px !important; } }';
        $('head').append('<style id="emoza-customizer-styles-' + 'product_swatch_button_top_bottom_padding_' + device + '">' + output + '</style>');
      });
    });
  });
  $.each($devices, function (device, mediaSize) {
    wp.customize('product_swatch_button_spacing_' + device, function (value) {
      value.bind(function (to) {
        $('head').find('#emoza-customizer-styles-' + 'product_swatch_button_spacing_' + device).remove();
        var output = '@media ' + mediaSize + ' { .emoza-variations-wrapper .emoza-variation-type-button { grid-gap:' + to + 'px !important; } }';
        $('head').append('<style id="emoza-customizer-styles-' + 'product_swatch_button_spacing_' + device + '">' + output + '</style>');
      });
    });
  });
  wp.customize('product_swatch_button_border_width', function (value) {
    value.bind(function (to) {
      $('.emoza-variations-wrapper .emoza-variation-type-button > a').css('border-width', to + 'px');
    });
  });
  wp.customize('product_swatch_button_border_radius', function (value) {
    value.bind(function (to) {
      $('.emoza-variations-wrapper .emoza-variation-type-button > a').css('border-radius', to + 'px');
    });
  });
  ...
  $.each($devices, function (device, mediaSize) {
    wp.customize('product_swatch_image_width_' + device, function (value) {
      value.bind(function (to) {
        $('head').find('#emoza-customizer-styles-' + 'product_swatch_image_width_' + device).remove();
        var output = '@media ' + mediaSize + ' { .emoza-variations-wrapper .emoza-variation-type-image > a { width:' + to + 'px !important; } }';
        $('head').append('<style id="emoza-customizer-styles-' + 'product_swatch_image_width_' + device + '">' + output + '</style>');
      });
    });
  });
  $.each($devices, function (device, mediaSize) {
    wp.customize('product_swatch_image_height_' + device, function (value) {
      value.bind(function (to) {
        $('head').find('#emoza-customizer-styles-' + 'product_swatch_image_height_' + device).remove();
        var output = '@media ' + mediaSize + ' { .emoza-variations-wrapper .emoza-variation-type-image > a { height:' + to + 'px !important; } }';
        $('head').append('<style id="emoza-customizer-styles-' + 'product_swatch_image_height_' + device + '">' + output + '</style>');
      });
    });
  });
  $.each($devices, function (device, mediaSize) {
    wp.customize('product_swatch_image_spacing_' + device, function (value) {
      value.bind(function (to) {
        $('head').find('#emoza-customizer-styles-' + 'product_swatch_image_spacing_' + device).remove();
        var output = '@media ' + mediaSize + ' { .emoza-variations-wrapper .emoza-variation-type-image { grid-gap:' + to + 'px !important; } }';
        $('head').append('<style id="emoza-customizer-styles-' + 'product_swatch_image_spacing_' + device + '">' + output + '</style>');
      });
    });
  });
  wp.customize('product_swatch_image_border_width', function (value) {
    value.bind(function (to) {
      $('head').find('#emoza-customizer-styles-product_swatch_image_border_width').remove();
      var output = '.emoza-variations-wrapper .emoza-variation-type-image > a { border-width:' + to + 'px !important; }';
      $('head').append('<style id="emoza-customizer-styles-product_swatch_image_border_width">' + output + '</style>');
    });
  });
  wp.customize('product_swatch_image_border_radius', function (value) {
    value.bind(function (to) {
      $('head').find('#emoza-customizer-styles-product_swatch_image_border_radius').remove();
      var selector = '.emoza-variations-wrapper .emoza-variation-type-image > a,';
      selector += '.emoza-variations-wrapper .emoza-variation-type-image > a img,';
      selector += '.emoza-variations-wrapper .emoza-variation-type-image > a:not(.disabled):before';
      $('head').append('<style id="emoza-customizer-styles-product_swatch_image_border_radius">' + selector + '{ border-radius:' + to + 'px !important; }</style>');
    });
  });
  ...
  if (typeof window.parent.wp.customize.section('emoza_section_adtcnotif') !== 'undefined') {
    window.parent.wp.customize.section('emoza_section_adtcnotif').expanded.bind(function (isExpanded) {
      if (isExpanded) {
        $('.emoza-adtcnotif').addClass('active');
      } else {
        $('.emoza-adtcnotif').removeClass('active');
      }
    });
  }
  wp.customize.bind('preview-ready', function () {
    if (jQuery(window.parent.document).find('#sub-accordion-section-emoza_section_adtcnotif').hasClass('open')) {
      $('.emoza-adtcnotif').addClass('active');
    }
  });

  // Theme options
  var $theme_options = emoza_theme_options;
  $.each($theme_options, function (key, css) {
    wp.customize(css.option, function (value) {
      value.bind(function (to, prev) {
        ...
        var $style = $('#emoza-customizer-styles-misc-' + css.option);
        if (output) {
          if ($style.length) {
            $style.text(output);
          } else {
            $('head').append('<style id="emoza-customizer-styles-misc-' + css.option + '">' + output + '</style>');
          }
  ...
  var $theme_options_css_vars = emoza_theme_options_css_vars;
          ...
          wp.customize(setting_name, function (setting_value) {
            setting_value.bind(function (to) {
              if (window.matchMedia(mediaSize).matches) {
                ...
                var $style = $('#emoza-customizer-styles-css-vars-' + setting_name);
                if (output) {
                  if ($style.length) {
                    $style.text(output);
                  } else {
                    $('head').append('<style id="emoza-customizer-styles-css-vars-' + setting_name + '">' + output + '</style>');
                  }
                } else if (!output && $style.length) {
                  $style.remove();
                }
  ...
  wp.customize('background_color', function (value) {
    value.bind(function (to) {
      $(':root').css('--emoza_background_color', to);
    });
  });
})(jQuery);
