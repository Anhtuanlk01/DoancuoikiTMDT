  ...
  window.bhfb = {
      ...
      for (var _i = 0, _areas = areas; _i < _areas.length; _i++) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var row = _step.value;
            var rowInputValue = $('#_customize-input-emoza_' + area + '_row__' + row + '_' + area + '_row').val();
            if (rowInputValue == '') {
              $('#_customize-input-emoza_' + area + '_row__' + row + '_' + area + '_row').val(emoza_hfb.rows.defaults[row + '_' + area + '_row']);
            }
          }
        } catch (err) {
          _iterator.e(err);
    ...
    customizeNavigation: function customizeNavigation() {
      ...
      for (var _i2 = 0, _rows = rows; _i2 < _rows.length; _i2++) {
        var row = _rows[_i2];
        for (var i = 1; i <= 6; i++) {
          sections.push('sub-accordion-section-emoza_header_row__' + row + '_header_row_column' + i);
          sections.push('sub-accordion-section-emoza_footer_row__' + row + '_footer_row_column' + i);
        }
      }
      ...
      $(document).on('click keydown', '.customize-section-back', function (e) {
        ...
        if (sections.includes(current_section_id)) {
          ...
          if (current_section_id.indexOf('above_header_row_column') !== -1) {
            wp.customize.section('emoza_section_hb_above_header_row').focus();
            return false;
          }
          if (current_section_id.indexOf('main_header_row_column') !== -1) {
            wp.customize.section('emoza_section_hb_main_header_row').focus();
            return false;
          }
          if (current_section_id.indexOf('below_header_row_column') !== -1) {
            wp.customize.section('emoza_section_hb_below_header_row').focus();
            return false;
          }

          // footer columns.
          if (current_section_id.indexOf('above_footer_row_column') !== -1) {
            wp.customize.section('emoza_section_fb_above_footer_row').focus();
            return false;
          }
          if (current_section_id.indexOf('main_footer_row_column') !== -1) {
            wp.customize.section('emoza_section_fb_main_footer_row').focus();
            return false;
          }
          if (current_section_id.indexOf('below_footer_row_column') !== -1) {
            wp.customize.section('emoza_section_fb_below_footer_row').focus();
            return false;
          }
    ...
    storeGlobals: function storeGlobals() {
      ...
      // Current Device.      
      $('.wp-full-overlay-footer .devices button, .emoza-devices-preview button').on('click', function () {
      ...
      // Column Area.
      $(document).on('click mouseover', '.emoza-bhfb-area:not(.bhfb-available-components)', function (e) {
        if ($('#emoza-bhfb-elements').hasClass('show')) {
          return false;
        }
        _this.currentRowInput = $('#_customize-input-emoza_' + _this.currentBuilderType + '_row__' + $(this).data('bhfb-row'));
        _this.currentRow = $(this).closest('.emoza-bhfb-row');
        _this.currentColumnPos = $(this).index() - 1;
        _this.currentColumn = $(this);
        if (!_this.currentRow.length && $(this).hasClass('emoza-bhfb-area-offcanvas')) {
          _this.currentRowInput = $('#_customize-input-emoza_header_row__mobile_offcanvas');
          _this.currentRow = $('.emoza-bhfb-area-offcanvas');
    ...
    devicesSwitcher: function devicesSwitcher() {
      ...
      $(' .wp-full-overlay-footer .devices button, .emoza-devices-preview button').on('click', function () {
        ...
        $('.emoza-bhfb-devices .emoza-bhfb-device-link').removeClass('active');
        $('.emoza-bhfb-devices .emoza-bhfb-device-link[data-device="' + device + '"]').addClass('active');
      });
      $('.emoza-bhfb-devices .emoza-bhfb-device-link').on('click', function (e) {
        e.preventDefault();
        var device = $(this).attr('data-device');
    ...
    getElementsUnused: function getElementsUnused() {
      var _this = this;
      var elements = emoza_hfb.components.desktop,
        mb_elements = emoza_hfb.components.mobile;
      var fields = ['#_customize-input-emoza_header_row__above_header_row', '#_customize-input-emoza_header_row__main_header_row', '#_customize-input-emoza_header_row__below_header_row', '#_customize-input-emoza_header_row__mobile_offcanvas'];
      if (_this.currentBuilderType === 'footer') {
        elements = emoza_hfb.components.footer;
        fields = ['#_customize-input-emoza_footer_row__above_footer_row', '#_customize-input-emoza_footer_row__main_footer_row', '#_customize-input-emoza_footer_row__below_footer_row'];
      }
    ...
    elementsPopup: function elementsPopup() {
      var _this = this;
      $(document).on('click', '.emoza-bhfb-area:not(.bhfb-available-components)', function (e) {
        var popup = _this.currentBuilder.find('#emoza-bhfb-elements'),
    ...
    closeElementsPopup: function closeElementsPopup(e) {
      var _this = this,
        popup = _this.currentBuilder.find('#emoza-bhfb-elements');
      if (e.target.closest('#emoza-bhfb-elements') === null) {
    ...
    elementsPopupContent: function elementsPopupContent() {
      ...
      var _this = this,
        ...
        elementsWrapper = $('.emoza-bhfb-elements-desktop'),
        mobileElementsWrapper = $('.emoza-bhfb-elements-mobile');
      ...
      if (elements.desktop.length) {
        ...
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
            ...
            elementsWrapper.append('<div class="emoza-bhfb-element emoza-bhfb-element-desktop">' + '<a href="#" class="bhfb-button" data-bhfb-id="' + element.id + '" data-bhfb-focus-section="emoza_section_' + cprefix + '_component__' + element.id + '">' + element.label + '</a>' + '</div>');
          }
        } catch (err) {
          _iterator7.e(err);
        } finally {
        ...
        elementsWrapper.append('<p class="bhfb-elements-message">' + emoza_hfb.i18n.elementsMessage + '</p>');
      }
      ...
      if (elements.mobile.length) {
        ...
        try {
          for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
            ...
            mobileElementsWrapper.append('<div class="emoza-bhfb-element emoza-bhfb-element-mobile">' + '<a href="#" class="bhfb-button" data-bhfb-id="' + _element.id + '" data-bhfb-focus-section="emoza_section_' + cprefix + '_component__' + _element.id + '">' + _element.label + '</a>' + '</div>');
          }
        } catch (err) {
          _iterator8.e(err);
        } finally {
        ...
        mobileElementsWrapper.append('<p class="bhfb-elements-message">' + emoza_hfb.i18n.elementsMessage + '</p>');
      }
    ...
    updateAvailableComponents: function updateAvailableComponents() {
      ...
      if (_this.currentBuilderType === 'header') {
        ...
        $('.emoza-header-builder-available-components').html('');
        $('.emoza-header-builder-available-components').html($('.emoza-bhfb-header .emoza-bhfb-elements-desktop').html());

        // Header Mobile Components.
        $('.emoza-header-builder-available-mobile-components').html('');
        $('.emoza-header-builder-available-mobile-components').html($('.emoza-bhfb-header .emoza-bhfb-elements-mobile').html());
      }
      if (_this.currentBuilderType === 'footer') {
        // Footer Components.
        $('.emoza-footer-builder-available-footer-components').html('');
        $('.emoza-footer-builder-available-footer-components').html($('.emoza-bhfb-footer .emoza-bhfb-elements-desktop').html());
      }
    },
    addUpsellComponents: function addUpsellComponents() {
      var _this = this;
      if (!emoza_hfb.upsell_components.enable) {
        return false;
      }
      var upsellComponentsHTML = '',
        components = _this.currentBuilderType === 'header' ? emoza_hfb.upsell_components.header : emoza_hfb.upsell_components.footer;
      var _iterator9 = _createForOfIteratorHelper(components),
        _step9;
      try {
        for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
          var component = _step9.value;
          upsellComponentsHTML += "\n                    <div class=\"emoza-bhfb-element emoza-bhfb-element-desktop\">\n                        <a href=\"#\" class=\"bhfb-button\">".concat(component.label, "</a> \n                    </div>\n                ");
        }
      } catch (err) {
        _iterator9.e(err);
      } finally {
      ...
      var upsellHTML = "\n                <div class=\"emoza-bhfb-upsell-components-wrapper\">\n                    <h4>".concat(emoza_hfb.upsell_components.title, "</h4>\n                    <div class=\"emoza-bhfb-upsell-components\">").concat(upsellComponentsHTML, "</div>\n                    <p>").concat(emoza_hfb.upsell_components.total, "</p>\n                    <a href=\"").concat(emoza_hfb.upsell_components.link, "\" target=\"_blank\" class=\"bhfb-upsell-button\">").concat(emoza_hfb.upsell_components.button, "</a>\n                </div>\n            ");
      $('#emoza-bhfb-elements .emoza-bhfb-elements-wrapper .emoza-bhfb-upsell-components-wrapper').remove();
      $('#emoza-bhfb-elements .emoza-bhfb-elements-wrapper').append(upsellHTML);
    },
    elementsButton: function elementsButton() {
      var _this = this;
      $(document).on('click', '.emoza-bhfb-element > a', function (e) {
        e.preventDefault();
        e.stopPropagation();
        var id = $(this).data('bhfb-id'),
          focusSection = $(this).data('bhfb-focus-section');
        if ($(this).closest('#emoza-bhfb-elements').length) {
          _this.elementsButtonAdd(id);

          // close elements popup.
          _this.currentBuilder.find('#emoza-bhfb-elements').removeClass('show');
        } else {
    ...
    elementsButtonAdd: function elementsButtonAdd(id) {
      ...
      if (_this.currentDevice === 'mobile' && _this.currentRow.hasClass('emoza-bhfb-area-offcanvas')) {
      ...
      if (_this.currentComponent === 'mobile_offcanvas_menu' && !_this.currentRow.hasClass('emoza-bhfb-area-offcanvas')) {
        return false;
      }
      if (_this.currentComponent === 'mobile_hamburger' && _this.currentRow.hasClass('emoza-bhfb-area-offcanvas')) {
        return false;
      }
      ...
      _this.builderGridContent();
      $('#emoza-bhfb-elements').removeClass('show');
    },
    ...
    elementsSortable: function elementsSortable() {
      var _this = this;
      $('.emoza-bhfb-area').each(function () {
        $(this).sortable({
          placeholder: "emoza-bhfb-element bhfb-ui-state-highlight",
          connectWith: '.emoza-bhfb-area',
          scroll: false,
          cancel: '.bhfb-edit-column',
          change: function change(e, ui) {
            _this.currentComponent = $(ui.item[0]).find('.bhfb-button').data('bhfb-id');
            _this.currentRow = !$(ui.placeholder[0]).closest('.emoza-bhfb-row').length ? $(ui.placeholder[0]).closest('.emoza-bhfb-area-offcanvas') : $(ui.placeholder[0]).closest('.emoza-bhfb-row');
            _this.currentRowInput = $('#_customize-input-emoza_' + _this.currentBuilderType + '_row__' + ui.placeholder.closest('.emoza-bhfb-area').data('bhfb-row'));
            var order = [];
            ui.placeholder.closest('.emoza-bhfb-area').find('.ui-sortable-placeholder').attr('data-bhfb-id', _this.currentComponent);
            ui.placeholder.closest('.emoza-bhfb-area').find('.emoza-bhfb-element').each(function () {
          ...
          update: function update(e, ui) {
            ...
            if (this === ui.item.parent()[0]) {
              var component_id = ui.item.find('> .bhfb-button').data('bhfb-id'),
                row = ui.item.closest('.emoza-bhfb-area').data('bhfb-row'),
                column = ui.item.closest('.emoza-bhfb-area').index() - 1,
              ...
              if (!ui.sender.hasClass('bhfb-available-components')) {
                _this.currentRowInput = $('#_customize-input-emoza_' + _this.currentBuilderType + '_row__' + prevRow);
              }
              _this.currentColumnPos = prevColumn;
              _this.elementsButtonRemove(component_id, true);
              if (!ui.sender.hasClass('bhfb-available-components')) {
                _this.currentRowInput = $('#_customize-input-emoza_' + _this.currentBuilderType + '_row__' + row);
              }
    ...
    builderGridContent: function builderGridContent() {
      var _this = this,
        fields = ['#_customize-input-emoza_header_row__above_header_row', '#_customize-input-emoza_header_row__main_header_row', '#_customize-input-emoza_header_row__below_header_row', '#_customize-input-emoza_header_row__mobile_offcanvas'],
        cprefix = 'hb';
      if (_this.currentBuilderType && _this.currentBuilderType === 'footer') {
        fields = ['#_customize-input-emoza_footer_row__above_footer_row', '#_customize-input-emoza_footer_row__main_footer_row', '#_customize-input-emoza_footer_row__below_footer_row'];
        cprefix = 'fb';
      ...
      setTimeout(function () {
        for (var _i4 = 0, _fields2 = fields; _i4 < _fields2.length; _i4++) {
          ...
          // Empty columns.
          $('.emoza-bhfb-area[data-bhfb-row="' + current_row + '_' + _this.currentBuilderType + '_row"]').each(function () {
            $(this).remove();
          });
                ...
                if (columns.length) {
                  ...
                  try {
                    for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
                      ...
                      column.append('<div class="emoza-bhfb-element">' + '<a href="#" class="bhfb-button" data-bhfb-id="' + _element2.id + '" data-bhfb-focus-section="emoza_section_' + cprefix + '_component__' + _element2.id + '">' + '<span class="bhfb-title-element">' + _element2.label + '</span>' + '<i class="bhfb-edit-element dashicons dashicons-admin-generic"></i>' + '<i class="bhfb-remove-element dashicons dashicons-no-alt"></i>' + '</a>' + '</div>');
                    }
                  } catch (err) {
                    _iterator11.e(err);
                  } finally {
          ...
          if (_this.currentDevice === 'mobile') {
            ...
            try {
              for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
                ...
                var _column = $('.emoza-bhfb-' + current_row + '-row').find('.emoza-bhfb-area:last-child');
                if (_columns.length) {
                  ...
                  try {
                    for (_iterator14.s(); !(_step14 = _iterator14.n()).done;) {
                      ...
                      _column.append('<div class="emoza-bhfb-element">' + '<a href="#" class="bhfb-button" data-bhfb-id="' + _element3.id + '" data-bhfb-focus-section="emoza_section_' + cprefix + '_component__' + _element3.id + '">' + '<span class="bhfb-title-element">' + _element3.label + '</span>' + '<i class="bhfb-edit-element dashicons dashicons-admin-generic"></i>' + '<i class="bhfb-remove-element dashicons dashicons-no-alt"></i>' + '</a>' + '</div>');
                    }
                  } catch (err) {
                    _iterator14.e(err);
                  } finally {
            ...
            if (field.indexOf('mobile_offcanvas') !== -1) {
              $('.emoza-bhfb-area-offcanvas').html('');
              if (value.mobile_offcanvas.length) {
                ...
                try {
                  for (_iterator13.s(); !(_step13 = _iterator13.n()).done;) {
                    ...
                    $('.emoza-bhfb-area-offcanvas').append('<div class="emoza-bhfb-element">' + '<a href="#" class="bhfb-button" data-bhfb-id="' + element.id + '" data-bhfb-focus-section="emoza_section_hb_component__' + element.id + '">' + '<span class="bhfb-title-element">' + element.label + '</span>' + '<i class="bhfb-edit-element dashicons dashicons-admin-generic"></i>' + '<i class="bhfb-remove-element dashicons dashicons-no-alt"></i>' + '</a>' + '</div>');
                  }
                } catch (err) {
                  _iterator13.e(err);
                } finally {
        ...
        if (_this.currentBuilder.hasClass('show') && !_this.currentBuilder.hasClass('show-bottom')) {
          $('.emoza-bhfb').css('height', 0);
          _this.currentBuilder.css('height', _this.currentBuilder.find('.emoza-bhfb-top').outerHeight() + 47);
        } else {
    ...
    getElementData: function getElementData(element) {
      var _this = this;
      var elements = [].concat(_toConsumableArray(emoza_hfb.components.desktop), _toConsumableArray(emoza_hfb.components.mobile));
      if (_this.currentBuilderType === 'footer') {
        elements = emoza_hfb.components.footer;
      }
    ...
    showHideBuilder: function showHideBuilder() {
      ...
      for (var _i5 = 0, _rows2 = rows; _i5 < _rows2.length; _i5++) {
        var row = _rows2[_i5];
        for (var i = 1; i <= 6; i++) {
          sections.push('emoza_header_row__' + row + '_header_row_column' + i);
          sections.push('emoza_footer_row__' + row + '_footer_row_column' + i);
        }
      }
      sections.forEach(function (section) {
        if (typeof wp.customize.section(section) !== 'undefined') {
          wp.customize.section(section).expanded.bind(function (is_active) {
            ...
            self.currentBuilderType = self.currentBuilder.hasClass('emoza-bhfb-header') ? 'header' : 'footer';
            if (is_active) {
            ...
            setTimeout(function () {
              ...
              if (section === 'emoza_section_hb_wrapper' || section === 'emoza_section_fb_wrapper') {
                // $( '.emoza-bhfb-' + self.currentBuilderType ).find( '.emoza-bhfb-above-row .emoza-bhfb-area' ).trigger( 'click' );
    ...
    getCurrentBuilderByComponent: function getCurrentBuilderByComponent(component) {
      if (component.indexOf('_hb_') !== -1 || component.indexOf('_header_') !== -1 || component.indexOf('header_image') !== -1) {
        return $('.emoza-bhfb-header');
      } else if (component.indexOf('_fb_') !== -1 || component.indexOf('_footer_') !== -1) {
        return $('.emoza-bhfb-footer');
      }
      return false;
    },
    showHideBuilderTop: function showHideBuilderTop() {
      var self = this;
      $('.emoza-bhfb-bottom-display').on('click', function (e) {
        e.preventDefault();
        $('body').toggleClass('bhfb-active-bottom');
        $(this).toggleClass('show');
        $('.emoza-bhfb-top').toggleClass('show');
        $('.emoza-bhfb').toggleClass('show-bottom');
        self.builderGridContent();
      });
    },
    builderCustomColumns: function builderCustomColumns() {
      var _this = this,
        options = ['emoza_header_row__above_header_row_columns', 'emoza_header_row__main_header_row_columns', 'emoza_header_row__below_header_row_columns', 'emoza_footer_row__above_footer_row_columns_desktop', 'emoza_footer_row__main_footer_row_columns_desktop', 'emoza_footer_row__below_footer_row_columns_desktop'];
            ...
            wp.customize(optionID + deviceSelector, function (option) {
              option.bind(function (to) {
                ...
                for (var _i7 = 0, _rows3 = rows; _i7 < _rows3.length; _i7++) {
                  var row = _rows3[_i7];
                  var rowOptionID = 'emoza_' + _this.currentBuilderType + '_row__' + row + '_' + _this.currentBuilderType,
                    rowInputSelector = '#_customize-input-emoza_' + _this.currentBuilderType + '_row__' + row + '_' + _this.currentBuilderType + '_row';
                  if (optionID.indexOf(rowOptionID) !== -1) {
                    rowSelector = 'emoza-bhfb-' + row + '-row';
      ...
      for (var _i8 = 0, _areas2 = areas; _i8 < _areas2.length; _i8++) {
        ...
        try {
          var _loop5 = function _loop5() {
            ...
            var sectionID = 'emoza_section_' + prefix + '_' + row + '_' + area + '_row';
              ...
              wp.customize.section(sectionID).expanded.bind(function (is_active) {
                if (is_active) {
                  ...
                  var _loop6 = function _loop6() {
                    ...
                    setTimeout(function () {
                      var rowSelector = 'emoza-bhfb-' + row + '-row',
                        columnsOptionID = 'emoza_' + _this.currentBuilderType + '_row__' + row + '_' + _this.currentBuilderType + '_row_columns_' + device;
                      _this.currentRow = row;
                      _this.currentRowInput = $('#_customize-input-emoza_' + _this.currentBuilderType + '_row__' + row + '_' + _this.currentBuilderType + '_row');
    ...
    addBuilderRowColumnsClass: function addBuilderRowColumnsClass(device, rowSelector, to) {
      ...
      for (var i = 1; i <= 6; i++) {
        $('.emoza-bhfb-' + _this.currentBuilderType + ' .emoza-bhfb-' + device + ' .emoza-bhfb-row.' + rowSelector).removeClass('emoza-bhfb-row-' + i + '-columns');
      }

      // Add new columns class.
      $('.emoza-bhfb-' + _this.currentBuilderType + ' .emoza-bhfb-' + device + ' .emoza-bhfb-row.' + rowSelector).addClass('emoza-bhfb-row-' + to + '-columns');
    },
    updateColumnsLayoutOption: function updateColumnsLayoutOption(device, val) {
      var _this = this,
        setting_id = 'emoza_' + _this.currentBuilderType + '_row__' + _this.currentRow + '_' + _this.currentBuilderType + '_row_columns_layout_' + device,
    ...
    builderColumnsLayout: function builderColumnsLayout() {
      var _this = this,
        options = ['emoza_header_row__above_header_row_columns_layout', 'emoza_header_row__main_header_row_columns_layout', 'emoza_header_row__below_header_row_columns_layout', 'emoza_footer_row__above_footer_row_columns_layout_desktop', 'emoza_footer_row__main_footer_row_columns_layout_desktop', 'emoza_footer_row__below_footer_row_columns_layout_desktop'];
      options.forEach(function (optionID) {
        if (typeof wp.customize.control(optionID) !== 'undefined') {
          var devices = optionID.indexOf('header') !== -1 ? ['desktop', 'tablet'] : ['desktop'];
          var _loop7 = function _loop7() {
            ...
            wp.customize(optionID + deviceSelector, function (option) {
              option.bind(function (to) {
                ...
                _this.currentRowInput = $('#_customize-input-emoza_' + _this.currentBuilderType + '_row__' + current_row + '_' + _this.currentBuilderType + '_row');
                var $builderRow = $('.emoza-bhfb-' + _this.currentBuilderType + ' .emoza-bhfb-' + device + ' .emoza-bhfb-row.emoza-bhfb-' + current_row + '-row');
                $builderRow.removeClass('emoza-bhfb-row-columns-layout-equal');
                $builderRow.removeClass('emoza-bhfb-row-columns-layout-bigleft');
                $builderRow.removeClass('emoza-bhfb-row-columns-layout-bigright');
                if (to.indexOf('equal') !== -1) {
                  $builderRow.addClass('emoza-bhfb-row-columns-layout-equal');
                }
                if (to.indexOf('bigleft') !== -1) {
                  $builderRow.addClass('emoza-bhfb-row-columns-layout-bigleft');
                }
                if (to.indexOf('bigright') !== -1) {
                  $builderRow.addClass('emoza-bhfb-row-columns-layout-bigright');
                }
    ...
    footerCustomizerOptions: function footerCustomizerOptions() {
      ...
      for (var _i11 = 0, _rows4 = rows; _i11 < _rows4.length; _i11++) {
        var row = _rows4[_i11];
        var fieldID = 'emoza_footer_row__' + row + '_footer_row';
    ...
    extraNavigation: function extraNavigation() {
      var _this = this;
      wp.customize.section('emoza_section_hb_mobile_offcanvas').expanded.bind(function (is_active) {
        if (!is_active) {
          return false;
        }
    ...
    headerPresets: function headerPresets() {
      var _this = this;
      wp.customize('emoza_section_hb_presets__header_preset_layout', function (option) {
        option.bind(function (to) {
    ...
    updateHeaderPreset: function updateHeaderPreset(preset) {
      var _this = this,
        $above_row = $('#_customize-input-emoza_header_row__above_header_row'),
        $main_row = $('#_customize-input-emoza_header_row__main_header_row'),
        $below_row = $('#_customize-input-emoza_header_row__below_header_row');

      // Set some others customizer settings.
      if (preset === 'header_layout_1') {
        wp.customize('emoza_header_row__main_header_row_column1_vertical_alignment_desktop').set('middle');
        wp.customize('emoza_header_row__main_header_row_column1_inner_layout_desktop').set('inline');
        wp.customize('emoza_header_row__main_header_row_column1_horizontal_alignment_desktop').set('start');
        wp.customize('emoza_header_row__main_header_row_column2_vertical_alignment_desktop').set('middle');
        wp.customize('emoza_header_row__main_header_row_column2_inner_layout_desktop').set('inline');
        wp.customize('emoza_header_row__main_header_row_column2_horizontal_alignment_desktop').set('center');
        wp.customize('emoza_header_row__main_header_row_column3_vertical_alignment_desktop').set('middle');
        wp.customize('emoza_header_row__main_header_row_column3_inner_layout_desktop').set('inline');
        wp.customize('emoza_header_row__main_header_row_column3_horizontal_alignment_desktop').set('end');
      }
      if (preset === 'header_layout_2') {
        ...
        wp.customize('emoza_header_row__main_header_row_column2_vertical_alignment_desktop').set('middle');
        wp.customize('emoza_header_row__main_header_row_column2_inner_layout_desktop').set('inline');
        wp.customize('emoza_header_row__main_header_row_column2_horizontal_alignment_desktop').set('end');
      }
      if (preset === 'header_layout_3') {
        ...
        wp.customize('emoza_header_row__main_header_row_column3_inner_layout_desktop').set('inline');
        wp.customize('emoza_header_row__main_header_row_column3_horizontal_alignment_desktop').set('end');
        wp.customize('emoza_header_row__below_header_row_column1_vertical_alignment_desktop').set('middle');
        wp.customize('emoza_header_row__below_header_row_column1_inner_layout_desktop').set('inline');
        wp.customize('emoza_header_row__below_header_row_column1_horizontal_alignment_desktop').set('center');
      }
      if (preset === 'header_layout_4') {
        ...
        wp.customize('emoza_header_row__below_header_row_column1_vertical_alignment_desktop').set('middle');
        wp.customize('emoza_header_row__below_header_row_column1_inner_layout_desktop').set('inline');
        wp.customize('emoza_header_row__below_header_row_column1_horizontal_alignment_desktop').set('start');
        wp.customize('emoza_header_row__below_header_row_column2_vertical_alignment_desktop').set('middle');
        wp.customize('emoza_header_row__below_header_row_column2_inner_layout_desktop').set('inline');
        wp.customize('emoza_header_row__below_header_row_column2_horizontal_alignment_desktop').set('end');
      }
      ...
      wp.customize('emoza_header_row__main_header_row_column1_vertical_alignment_tablet').set('middle');
      wp.customize('emoza_header_row__main_header_row_column1_inner_layout_tablet').set('inline');
      wp.customize('emoza_header_row__main_header_row_column1_horizontal_alignment_tablet').set('start');
      wp.customize('emoza_header_row__main_header_row_column1_vertical_alignment_mobile').set('middle');
      wp.customize('emoza_header_row__main_header_row_column1_inner_layout_mobile').set('inline');
      wp.customize('emoza_header_row__main_header_row_column1_horizontal_alignment_mobile').set('start');
      wp.customize('emoza_header_row__main_header_row_column2_vertical_alignment_tablet').set('middle');
      wp.customize('emoza_header_row__main_header_row_column2_inner_layout_tablet').set('inline');
      wp.customize('emoza_header_row__main_header_row_column2_horizontal_alignment_tablet').set('center');
      wp.customize('emoza_header_row__main_header_row_column2_vertical_alignment_mobile').set('middle');
      wp.customize('emoza_header_row__main_header_row_column2_inner_layout_mobile').set('inline');
      wp.customize('emoza_header_row__main_header_row_column2_horizontal_alignment_mobile').set('center');
      wp.customize('emoza_header_row__main_header_row_column3_vertical_alignment_tablet').set('middle');
      wp.customize('emoza_header_row__main_header_row_column3_inner_layout_tablet').set('inline');
      wp.customize('emoza_header_row__main_header_row_column3_horizontal_alignment_tablet').set('end');
      wp.customize('emoza_header_row__main_header_row_column3_vertical_alignment_mobile').set('middle');
      wp.customize('emoza_header_row__main_header_row_column3_inner_layout_mobile').set('inline');
      wp.customize('emoza_header_row__main_header_row_column3_horizontal_alignment_mobile').set('end');

      // Set row settings and trigger change.
      $above_row.val(emoza_hfb.header_presets[preset]['above_row']).trigger('change');
      $main_row.val(emoza_hfb.header_presets[preset]['main_row']).trigger('change');
      $below_row.val(emoza_hfb.header_presets[preset]['below_row']).trigger('change');
