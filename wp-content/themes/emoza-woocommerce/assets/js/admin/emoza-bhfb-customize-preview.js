...
(function ($) {
  ...
  wp.customize.bind('preview-ready', function () {
    $(document).on('click', '.bhfb-item-customizer-focus', function (e) {
      ...
      // Check builder type.
      var currentBuilderSelector = '.emoza-bhfb-header';
      if ($(this).closest('.bhfb-footer').length) {
        currentBuilderSelector = '.emoza-bhfb-footer';
      }

      // Go to component section.
      if ($(this).closest('.bhfb-header').length || $(this).closest('.bhfb-mobile_offcanvas').length) {
        window.parent.wp.customize.section('emoza_section_hb_component__' + id).focus();
      } else {
        window.parent.wp.customize.section('emoza_section_fb_component__' + id).focus();
      }
    ...
    $('html').on('mouseup', function () {
      $(window.parent.document).find('#emoza-bhfb-elements').removeClass('show');
    });
  ...
  var css = {
    // Header Rows Border
    'emoza_header_row__above_header_row_border_bottom_desktop': {
      'selector': '.bhfb-above_header_row',
      'prop': 'border-bottom-width',
      'unit': 'px'
    },
    'emoza_header_row__main_header_row_border_bottom_desktop': {
      'selector': '.bhfb-main_header_row',
      'prop': 'border-bottom-width',
      'unit': 'px'
    },
    'emoza_header_row__below_header_row_border_bottom_desktop': {
      'selector': '.bhfb-below_header_row',
      'prop': 'border-bottom-width',
      'unit': 'px'
    },
    // Footer Rows Border
    'emoza_footer_row__above_footer_row_border_top_desktop': {
      'selector': '.bhfb-above_footer_row',
      'prop': 'border-top-width',
      'unit': 'px'
    },
    'emoza_footer_row__main_footer_row_border_top_desktop': {
      'selector': '.bhfb-main_footer_row',
      'prop': 'border-top-width',
      'unit': 'px'
    },
    'emoza_footer_row__below_footer_row_border_top_desktop': {
    ...
    'link_separator_color': {
      'selector': '.emoza-offcanvas-menu .emoza-dropdown ul li',
  ...
  var $devices = {
    ...
    resp_css = {
      // Header Rows.
      'emoza_header_row__above_header_row_height': {
        'selector': '.bhfb-above_header_row',
        'prop': 'min-height',
        'unit': 'px'
      },
      'emoza_header_row__main_header_row_height': {
        'selector': '.bhfb-main_header_row',
        'prop': 'min-height',
        'unit': 'px'
      },
      'emoza_header_row__below_header_row_height': {
        'selector': '.bhfb-below_header_row',
        'prop': 'min-height',
        'unit': 'px'
      },
      // Footer Rows.
      'emoza_footer_row__above_footer_row_height': {
        'selector': '.bhfb-above_footer_row',
        'prop': 'min-height',
        'unit': 'px'
      },
      'emoza_footer_row__main_footer_row_height': {
        'selector': '.bhfb-main_footer_row',
        'prop': 'min-height',
        'unit': 'px'
      },
      'emoza_footer_row__below_footer_row_height': {
        'selector': '.bhfb-below_footer_row',
        'prop': 'min-height',
        'unit': 'px'
      },
      ...
      'emoza_section_fb_component__html2_text_align': {
        'selector': '.bhfb.bhfb-footer .bhfb-component-html2',
        'prop': 'text-align'
      },
      // Footer Shortcode Component Text Alignment.
      'emoza_section_fb_component__shortcode_text_align': {
          ...
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            try {
              for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                ...
                var optionID = 'emoza_' + builder + '_row__' + row + '_' + builder + '_row_column' + i + '_' + opt,
